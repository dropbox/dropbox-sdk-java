 ...
 * DbxUserFilesRequests#alphaUpload(String)}.
 *
 ...
 */
public class AlphaUploadUploader extends DbxUploader<FileMetadata, UploadError, UploadErrorException> {
     ...
     */
    public AlphaUploadUploader(HttpRequestor.Uploader httpUploader, String userId) {
    ...
    protected UploadErrorException newException(DbxWrappedException error) {
        return new UploadErrorException("2/files/alpha/upload", error.getRequestId(), error.getUserMessage(), (UploadError) error.getErrorValue());
    }
}
