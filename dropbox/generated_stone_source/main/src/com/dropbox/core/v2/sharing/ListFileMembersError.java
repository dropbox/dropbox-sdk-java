...
public final class ListFileMembersError {
     ...
     */
    private ListFileMembersError withTag(Tag _tag) {
        ListFileMembersError result = new ListFileMembersError();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private ListFileMembersError withTagAndUserError(Tag _tag, SharingUserError userErrorValue) {
        ListFileMembersError result = new ListFileMembersError();
        result._tag = _tag;
     ...
     *     preconditions.
     */
    private ListFileMembersError withTagAndAccessError(Tag _tag, SharingFileAccessError accessErrorValue) {
        ListFileMembersError result = new ListFileMembersError();
        result._tag = _tag;
    ...
    public static ListFileMembersError userError(SharingUserError value) {
        ...
        return new ListFileMembersError().withTagAndUserError(Tag.USER_ERROR, value);
    }
    ...
    public static ListFileMembersError accessError(SharingFileAccessError value) {
        ...
        return new ListFileMembersError().withTagAndAccessError(Tag.ACCESS_ERROR, value);
    }
