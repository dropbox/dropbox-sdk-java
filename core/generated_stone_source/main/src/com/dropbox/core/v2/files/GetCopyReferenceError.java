...
public final class GetCopyReferenceError {
     ...
     */
    private GetCopyReferenceError withTag(Tag _tag) {
        GetCopyReferenceError result = new GetCopyReferenceError();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private GetCopyReferenceError withTagAndPath(Tag _tag, LookupError pathValue) {
        GetCopyReferenceError result = new GetCopyReferenceError();
        result._tag = _tag;
    ...
    public static GetCopyReferenceError path(LookupError value) {
        ...
        return new GetCopyReferenceError().withTagAndPath(Tag.PATH, value);
    }
