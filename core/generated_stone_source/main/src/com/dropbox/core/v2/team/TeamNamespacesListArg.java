...
class TeamNamespacesListArg {
    // struct team.TeamNamespacesListArg (team_namespaces.stone)
     ...
     *     preconditions.
     */
    public TeamNamespacesListArg(long limit) {
        if (limit < 1L) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamNamespacesListArg other = (TeamNamespacesListArg) obj;
    ...
    static class Serializer extends StructSerializer<TeamNamespacesListArg> {
        ...
        @Override
        public void serialize(TeamNamespacesListArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamNamespacesListArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamNamespacesListArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamNamespacesListArg(f_limit);
            }
            else {
