...
public enum PropertiesSearchContinueError {
    ...
    static class Serializer extends UnionSerializer<PropertiesSearchContinueError> {
        ...
        @Override
        public void serialize(PropertiesSearchContinueError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (value) {
                case RESET: {
                    g.writeString("reset");
                    break;
        ...
        @Override
        public PropertiesSearchContinueError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = PropertiesSearchContinueError.RESET;
            }
            else {
                value = PropertiesSearchContinueError.OTHER;
            }
            if (!collapsed) {
                skipFields(p);
                expectEndObject(p);
