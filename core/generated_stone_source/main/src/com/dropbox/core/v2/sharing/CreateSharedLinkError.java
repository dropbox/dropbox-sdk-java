...
public final class CreateSharedLinkError {
     ...
     */
    private CreateSharedLinkError withTag(Tag _tag) {
        CreateSharedLinkError result = new CreateSharedLinkError();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private CreateSharedLinkError withTagAndPath(Tag _tag, LookupError pathValue) {
        CreateSharedLinkError result = new CreateSharedLinkError();
        result._tag = _tag;
    ...
    public static CreateSharedLinkError path(LookupError value) {
        ...
        return new CreateSharedLinkError().withTagAndPath(Tag.PATH, value);
    }
