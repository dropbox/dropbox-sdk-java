...
public class PaperExternalViewForbidDetails {
    // struct team_log.PaperExternalViewForbidDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperExternalViewForbidDetails(@Nonnull String eventUuid) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperExternalViewForbidDetails other = (PaperExternalViewForbidDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperExternalViewForbidDetails> {
        ...
        @Override
        public void serialize(PaperExternalViewForbidDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperExternalViewForbidDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
