...
public final class ThumbnailError {
    // union files.ThumbnailError (files_files_public_base.stone)
     ...
     * Encrypted content cannot be converted to a thumbnail.
     */
    public static final ThumbnailError ENCRYPTED_CONTENT = new ThumbnailError().withTag(Tag.ENCRYPTED_CONTENT);
    /**
     * An error occurs during thumbnail conversion.
     */
    ...
    static class Serializer extends UnionSerializer<ThumbnailError> {
        ...
        public ThumbnailError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = ThumbnailError.ENCRYPTED_CONTENT;
            }
