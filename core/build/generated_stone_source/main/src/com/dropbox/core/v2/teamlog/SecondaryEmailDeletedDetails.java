...
public class SecondaryEmailDeletedDetails {
    // struct team_log.SecondaryEmailDeletedDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     * Deleted secondary email.
     *
     * @param secondaryEmail  Deleted secondary email. Must have length of at
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SecondaryEmailDeletedDetails other = (SecondaryEmailDeletedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<SecondaryEmailDeletedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(SecondaryEmailDeletedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SecondaryEmailDeletedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SecondaryEmailDeletedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SecondaryEmailDeletedDetails(f_secondaryEmail);
            }
            else {
