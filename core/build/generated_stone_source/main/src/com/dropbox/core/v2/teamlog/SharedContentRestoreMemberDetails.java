...
public class SharedContentRestoreMemberDetails {
    // struct team_log.SharedContentRestoreMemberDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharedContentRestoreMemberDetails other = (SharedContentRestoreMemberDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<SharedContentRestoreMemberDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(SharedContentRestoreMemberDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedContentRestoreMemberDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SharedContentRestoreMemberDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SharedContentRestoreMemberDetails(f_sharedContentAccessLevel);
            }
            else {
