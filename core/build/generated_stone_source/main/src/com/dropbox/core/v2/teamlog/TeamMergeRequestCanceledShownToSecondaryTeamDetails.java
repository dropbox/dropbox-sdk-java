...
public class TeamMergeRequestCanceledShownToSecondaryTeamDetails {
    // struct team_log.TeamMergeRequestCanceledShownToSecondaryTeamDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public TeamMergeRequestCanceledShownToSecondaryTeamDetails(@Nonnull String sentTo, @Nonnull String sentBy) {
        if (sentTo == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamMergeRequestCanceledShownToSecondaryTeamDetails other = (TeamMergeRequestCanceledShownToSecondaryTeamDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamMergeRequestCanceledShownToSecondaryTeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamMergeRequestCanceledShownToSecondaryTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamMergeRequestCanceledShownToSecondaryTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamMergeRequestCanceledShownToSecondaryTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamMergeRequestCanceledShownToSecondaryTeamDetails(f_sentTo, f_sentBy);
            }
            else {
