...
public class DomainVerificationAddDomainSuccessType {
    // struct team_log.DomainVerificationAddDomainSuccessType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            DomainVerificationAddDomainSuccessType other = (DomainVerificationAddDomainSuccessType) obj;
    ...
    static class Serializer extends StructSerializer<DomainVerificationAddDomainSuccessType> {
        ...
        @Override
        public void serialize(DomainVerificationAddDomainSuccessType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DomainVerificationAddDomainSuccessType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new DomainVerificationAddDomainSuccessType(f_description);
            }
            else {
