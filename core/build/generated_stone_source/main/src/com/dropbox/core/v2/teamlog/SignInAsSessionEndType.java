...
public class SignInAsSessionEndType {
    // struct team_log.SignInAsSessionEndType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SignInAsSessionEndType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SignInAsSessionEndType other = (SignInAsSessionEndType) obj;
    ...
    static class Serializer extends StructSerializer<SignInAsSessionEndType> {
        ...
        @Override
        public void serialize(SignInAsSessionEndType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SignInAsSessionEndType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SignInAsSessionEndType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SignInAsSessionEndType(f_description);
            }
            else {
