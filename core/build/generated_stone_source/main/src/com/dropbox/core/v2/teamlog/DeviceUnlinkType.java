...
public class DeviceUnlinkType {
    // struct team_log.DeviceUnlinkType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            DeviceUnlinkType other = (DeviceUnlinkType) obj;
    ...
    static class Serializer extends StructSerializer<DeviceUnlinkType> {
        ...
        @Override
        public void serialize(DeviceUnlinkType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DeviceUnlinkType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            DeviceUnlinkType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new DeviceUnlinkType(f_description);
            }
            else {
