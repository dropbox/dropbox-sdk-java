...
public class GroupAddExternalIdDetails {
    // struct team_log.GroupAddExternalIdDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GroupAddExternalIdDetails other = (GroupAddExternalIdDetails) obj;
    ...
    static class Serializer extends StructSerializer<GroupAddExternalIdDetails> {
        ...
        @Override
        public void serialize(GroupAddExternalIdDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GroupAddExternalIdDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GroupAddExternalIdDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GroupAddExternalIdDetails(f_newValue);
            }
            else {
