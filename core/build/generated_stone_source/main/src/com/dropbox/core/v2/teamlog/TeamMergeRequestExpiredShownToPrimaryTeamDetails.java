...
public class TeamMergeRequestExpiredShownToPrimaryTeamDetails {
    // struct team_log.TeamMergeRequestExpiredShownToPrimaryTeamDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamMergeRequestExpiredShownToPrimaryTeamDetails other = (TeamMergeRequestExpiredShownToPrimaryTeamDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamMergeRequestExpiredShownToPrimaryTeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamMergeRequestExpiredShownToPrimaryTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamMergeRequestExpiredShownToPrimaryTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamMergeRequestExpiredShownToPrimaryTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamMergeRequestExpiredShownToPrimaryTeamDetails(f_secondaryTeam, f_sentBy);
            }
            else {
