...
public class GuestAdminSignedOutViaTrustedTeamsDetails {
    // struct team_log.GuestAdminSignedOutViaTrustedTeamsDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    /**
     * Builder for {@link GuestAdminSignedOutViaTrustedTeamsDetails}.
     */
    public static class Builder {
         ...
         * GuestAdminSignedOutViaTrustedTeamsDetails} configured with this
         * builder's values
         *
         * @return new instance of {@link
         *     GuestAdminSignedOutViaTrustedTeamsDetails}
         */
        public GuestAdminSignedOutViaTrustedTeamsDetails build() {
            return new GuestAdminSignedOutViaTrustedTeamsDetails(teamName, trustedTeamName);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GuestAdminSignedOutViaTrustedTeamsDetails other = (GuestAdminSignedOutViaTrustedTeamsDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<GuestAdminSignedOutViaTrustedTeamsDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(GuestAdminSignedOutViaTrustedTeamsDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GuestAdminSignedOutViaTrustedTeamsDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GuestAdminSignedOutViaTrustedTeamsDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GuestAdminSignedOutViaTrustedTeamsDetails(f_teamName, f_trustedTeamName);
            }
            else {
