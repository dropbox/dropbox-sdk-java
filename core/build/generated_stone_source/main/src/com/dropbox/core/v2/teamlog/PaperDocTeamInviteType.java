...
public class PaperDocTeamInviteType {
    // struct team_log.PaperDocTeamInviteType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocTeamInviteType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocTeamInviteType other = (PaperDocTeamInviteType) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocTeamInviteType> {
        ...
        @Override
        public void serialize(PaperDocTeamInviteType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocTeamInviteType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocTeamInviteType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocTeamInviteType(f_description);
            }
            else {
