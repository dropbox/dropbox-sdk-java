...
public class SfTeamJoinDetails {
    // struct team_log.SfTeamJoinDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SfTeamJoinDetails(long targetAssetIndex, @Nonnull String originalFolderName) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SfTeamJoinDetails other = (SfTeamJoinDetails) obj;
    ...
    static class Serializer extends StructSerializer<SfTeamJoinDetails> {
        ...
        @Override
        public void serialize(SfTeamJoinDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SfTeamJoinDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SfTeamJoinDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SfTeamJoinDetails(f_targetAssetIndex, f_originalFolderName);
            }
            else {
