...
public class BinderReorderPageDetails {
    // struct team_log.BinderReorderPageDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public BinderReorderPageDetails(@javax.annotation.Nonnull String eventUuid, @javax.annotation.Nonnull String docTitle, @javax.annotation.Nonnull String binderItemName) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            BinderReorderPageDetails other = (BinderReorderPageDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<BinderReorderPageDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(BinderReorderPageDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public BinderReorderPageDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            BinderReorderPageDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new BinderReorderPageDetails(f_eventUuid, f_docTitle, f_binderItemName);
            }
            else {
