...
public class BinderReorderPageDetails {
    // struct team_log.BinderReorderPageDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public BinderReorderPageDetails(@Nonnull String eventUuid, @Nonnull String docTitle, @Nonnull String binderItemName) {
        if (eventUuid == null) {
