...
class DeleteSecondaryEmailsArg {
    // struct team.DeleteSecondaryEmailsArg (team_apiv2_team_members_secondary_emails.stone)
     ...
     *     preconditions.
     */
    public DeleteSecondaryEmailsArg(@Nonnull List<UserSecondaryEmailsArg> emailsToDelete) {
