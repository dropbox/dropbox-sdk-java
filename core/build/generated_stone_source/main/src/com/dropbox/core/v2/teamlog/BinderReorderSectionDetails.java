...
public class BinderReorderSectionDetails {
     ...
     *     preconditions.
     */
    public BinderReorderSectionDetails(@javax.annotation.Nonnull String eventUuid, @javax.annotation.Nonnull String docTitle, @javax.annotation.Nonnull String binderItemName) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            BinderReorderSectionDetails other = (BinderReorderSectionDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<BinderReorderSectionDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(BinderReorderSectionDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public BinderReorderSectionDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            BinderReorderSectionDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new BinderReorderSectionDetails(f_eventUuid, f_docTitle, f_binderItemName);
            }
            else {
