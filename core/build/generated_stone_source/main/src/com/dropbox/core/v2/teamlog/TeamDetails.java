...
public class TeamDetails {
    // struct team_log.TeamDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     */
    static class Serializer extends StructSerializer<TeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
