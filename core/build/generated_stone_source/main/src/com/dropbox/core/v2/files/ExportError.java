...
public final class ExportError {
    // union files.ExportError (files_files_public_types.stone)
    ...
    /**
     * Returns {@code true} if this instance has the tag {@link
     * Tag#INVALID_EXPORT_FORMAT}, {@code false} otherwise.
     *
     * @return {@code true} if this instance is tagged as {@link
     *     Tag#INVALID_EXPORT_FORMAT}, {@code false} otherwise.
     */
    ...
    public static class Serializer extends UnionSerializer<ExportError> {
        ...
        public ExportError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            else if ("invalid_export_format".equals(tag)) {
                value = ExportError.INVALID_EXPORT_FORMAT;
            }
