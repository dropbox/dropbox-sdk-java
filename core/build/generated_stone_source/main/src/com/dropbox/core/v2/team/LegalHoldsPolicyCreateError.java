...
public enum LegalHoldsPolicyCreateError {
    // union team.LegalHoldsPolicyCreateError (team_team_legal_holds.stone)
    /**
    ...
    static class Serializer extends UnionSerializer<LegalHoldsPolicyCreateError> {
        ...
        public void serialize(LegalHoldsPolicyCreateError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (value) {
                ...
                case TEAM_EXCEEDED_LEGAL_HOLD_QUOTA: {
                    g.writeString("team_exceeded_legal_hold_quota");
                    break;
                }
                case INVALID_DATE: {
                    g.writeString("invalid_date");
                    break;
                }
                default: {
        ...
        public LegalHoldsPolicyCreateError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            else if ("team_exceeded_legal_hold_quota".equals(tag)) {
                value = LegalHoldsPolicyCreateError.TEAM_EXCEEDED_LEGAL_HOLD_QUOTA;
            }
            else if ("invalid_date".equals(tag)) {
                value = LegalHoldsPolicyCreateError.INVALID_DATE;
            }
            else {
