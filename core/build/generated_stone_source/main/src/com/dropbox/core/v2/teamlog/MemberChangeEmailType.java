...
public class MemberChangeEmailType {
    // struct team_log.MemberChangeEmailType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            MemberChangeEmailType other = (MemberChangeEmailType) obj;
    ...
    static class Serializer extends StructSerializer<MemberChangeEmailType> {
        ...
        @Override
        public void serialize(MemberChangeEmailType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public MemberChangeEmailType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            MemberChangeEmailType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new MemberChangeEmailType(f_description);
            }
            else {
