...
public class SharedLinkSettingsRemovePasswordDetails {
     ...
     *     preconditions.
     */
    public SharedLinkSettingsRemovePasswordDetails(@javax.annotation.Nonnull AccessLevel sharedContentAccessLevel, @javax.annotation.Nullable String sharedContentLink) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharedLinkSettingsRemovePasswordDetails other = (SharedLinkSettingsRemovePasswordDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<SharedLinkSettingsRemovePasswordDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(SharedLinkSettingsRemovePasswordDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedLinkSettingsRemovePasswordDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SharedLinkSettingsRemovePasswordDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SharedLinkSettingsRemovePasswordDetails(f_sharedContentAccessLevel, f_sharedContentLink);
            }
            else {
