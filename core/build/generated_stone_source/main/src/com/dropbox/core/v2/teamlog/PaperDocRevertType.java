...
public class PaperDocRevertType {
    // struct team_log.PaperDocRevertType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocRevertType other = (PaperDocRevertType) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocRevertType> {
        ...
        @Override
        public void serialize(PaperDocRevertType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocRevertType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocRevertType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocRevertType(f_description);
            }
            else {
