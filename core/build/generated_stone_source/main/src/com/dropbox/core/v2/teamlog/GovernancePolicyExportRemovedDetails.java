...
public class GovernancePolicyExportRemovedDetails {
    // struct team_log.GovernancePolicyExportRemovedDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GovernancePolicyExportRemovedDetails other = (GovernancePolicyExportRemovedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<GovernancePolicyExportRemovedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(GovernancePolicyExportRemovedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GovernancePolicyExportRemovedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GovernancePolicyExportRemovedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GovernancePolicyExportRemovedDetails(f_governancePolicyId, f_name, f_exportName, f_policyType);
            }
            else {
