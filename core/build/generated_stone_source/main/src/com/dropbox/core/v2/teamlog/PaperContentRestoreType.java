...
public class PaperContentRestoreType {
    // struct team_log.PaperContentRestoreType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperContentRestoreType other = (PaperContentRestoreType) obj;
    ...
    static class Serializer extends StructSerializer<PaperContentRestoreType> {
        ...
        @Override
        public void serialize(PaperContentRestoreType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperContentRestoreType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperContentRestoreType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperContentRestoreType(f_description);
            }
            else {
