...
public class WebSessionsChangeFixedLengthPolicyType {
    // struct team_log.WebSessionsChangeFixedLengthPolicyType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public WebSessionsChangeFixedLengthPolicyType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            WebSessionsChangeFixedLengthPolicyType other = (WebSessionsChangeFixedLengthPolicyType) obj;
    ...
    static class Serializer extends StructSerializer<WebSessionsChangeFixedLengthPolicyType> {
        ...
        @Override
        public void serialize(WebSessionsChangeFixedLengthPolicyType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public WebSessionsChangeFixedLengthPolicyType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new WebSessionsChangeFixedLengthPolicyType(f_description);
            }
            else {
