...
public class ShowcaseUntrashedDeprecatedType {
    // struct team_log.ShowcaseUntrashedDeprecatedType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ShowcaseUntrashedDeprecatedType(@Nonnull String description) {
        if (description == null) {
