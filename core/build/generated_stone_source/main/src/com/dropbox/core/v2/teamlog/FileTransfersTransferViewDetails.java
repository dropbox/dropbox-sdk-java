...
public class FileTransfersTransferViewDetails {
    // struct team_log.FileTransfersTransferViewDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileTransfersTransferViewDetails other = (FileTransfersTransferViewDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<FileTransfersTransferViewDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(FileTransfersTransferViewDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileTransfersTransferViewDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileTransfersTransferViewDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileTransfersTransferViewDetails(f_fileTransferId);
            }
            else {
