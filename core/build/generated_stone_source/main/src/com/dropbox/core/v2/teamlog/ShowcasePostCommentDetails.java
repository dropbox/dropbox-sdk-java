...
public class ShowcasePostCommentDetails {
    // struct team_log.ShowcasePostCommentDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ShowcasePostCommentDetails(@javax.annotation.Nonnull String eventUuid, @javax.annotation.Nullable String commentText) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcasePostCommentDetails other = (ShowcasePostCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<ShowcasePostCommentDetails> {
        ...
        @Override
        public void serialize(ShowcasePostCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcasePostCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShowcasePostCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShowcasePostCommentDetails(f_eventUuid, f_commentText);
            }
            else {
