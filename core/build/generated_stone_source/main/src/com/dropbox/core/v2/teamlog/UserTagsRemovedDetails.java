...
public class UserTagsRemovedDetails {
    // struct team_log.UserTagsRemovedDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            UserTagsRemovedDetails other = (UserTagsRemovedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<UserTagsRemovedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(UserTagsRemovedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UserTagsRemovedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            UserTagsRemovedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new UserTagsRemovedDetails(f_values);
            }
            else {
