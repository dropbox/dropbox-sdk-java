...
public class SharedContentAddMemberType {
    // struct team_log.SharedContentAddMemberType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SharedContentAddMemberType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharedContentAddMemberType other = (SharedContentAddMemberType) obj;
    ...
    static class Serializer extends StructSerializer<SharedContentAddMemberType> {
        ...
        @Override
        public void serialize(SharedContentAddMemberType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedContentAddMemberType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SharedContentAddMemberType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SharedContentAddMemberType(f_description);
            }
            else {
