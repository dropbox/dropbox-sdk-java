...
public class GetTemplateArg {
    // struct file_properties.GetTemplateArg (file_properties_apiv2_file_properties_types.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GetTemplateArg other = (GetTemplateArg) obj;
    ...
    public static class Serializer extends StructSerializer<GetTemplateArg> {
        ...
        @Override
        public void serialize(GetTemplateArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GetTemplateArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GetTemplateArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GetTemplateArg(f_templateId);
            }
            else {
