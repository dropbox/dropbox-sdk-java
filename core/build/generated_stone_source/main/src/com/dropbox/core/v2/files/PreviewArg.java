...
class PreviewArg {
    // struct files.PreviewArg (files_files_public_base.stone)
     ...
     *     preconditions.
     */
    public PreviewArg(@Nonnull String path, @Nullable String rev) {
        if (path == null) {
     ...
     * DbxUserFilesRequests#getPreview(String,String)} instead.
     *
