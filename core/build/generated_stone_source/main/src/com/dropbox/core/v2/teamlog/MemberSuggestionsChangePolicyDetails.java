...
public class MemberSuggestionsChangePolicyDetails {
    // struct team_log.MemberSuggestionsChangePolicyDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     * team.
     *
     * @param newValue  New team member suggestions policy. Must not be {@code
     *     null}.
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            MemberSuggestionsChangePolicyDetails other = (MemberSuggestionsChangePolicyDetails) obj;
    ...
    static class Serializer extends StructSerializer<MemberSuggestionsChangePolicyDetails> {
        ...
        @Override
        public void serialize(MemberSuggestionsChangePolicyDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
            g.writeFieldName("new_value");
            MemberSuggestionsPolicy.Serializer.INSTANCE.serialize(value.newValue, g);
            if (value.previousValue != null) {
                g.writeFieldName("previous_value");
                StoneSerializers.nullable(MemberSuggestionsPolicy.Serializer.INSTANCE).serialize(value.previousValue, g);
            }
            if (!collapse) {
                g.writeEndObject();
            }
        ...
        @Override
        public MemberSuggestionsChangePolicyDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            MemberSuggestionsChangePolicyDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                MemberSuggestionsPolicy f_newValue = null;
                MemberSuggestionsPolicy f_previousValue = null;
                while (p.getCurrentToken() == JsonToken.FIELD_NAME) {
                    String field = p.getCurrentName();
                    p.nextToken();
                    if ("new_value".equals(field)) {
                        f_newValue = MemberSuggestionsPolicy.Serializer.INSTANCE.deserialize(p);
                    }
                    else if ("previous_value".equals(field)) {
                        f_previousValue = StoneSerializers.nullable(MemberSuggestionsPolicy.Serializer.INSTANCE).deserialize(p);
                    }
                    else {
                        skipValue(p);
                    }
                ...
                value = new MemberSuggestionsChangePolicyDetails(f_newValue, f_previousValue);
            }
            else {
