...
public class NoPasswordLinkGenReportFailedDetails {
    // struct team_log.NoPasswordLinkGenReportFailedDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public NoPasswordLinkGenReportFailedDetails(@Nonnull TeamReportFailureReason failureReason) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            NoPasswordLinkGenReportFailedDetails other = (NoPasswordLinkGenReportFailedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<NoPasswordLinkGenReportFailedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(NoPasswordLinkGenReportFailedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public NoPasswordLinkGenReportFailedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            NoPasswordLinkGenReportFailedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new NoPasswordLinkGenReportFailedDetails(f_failureReason);
            }
            else {
