...
public class PaperDocUntrashedDetails {
    // struct team_log.PaperDocUntrashedDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocUntrashedDetails(@Nonnull String eventUuid) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocUntrashedDetails other = (PaperDocUntrashedDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocUntrashedDetails> {
        ...
        @Override
        public void serialize(PaperDocUntrashedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocUntrashedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocUntrashedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocUntrashedDetails(f_eventUuid);
            }
            else {
