...
public class SmartSyncOptOutDetails {
    // struct team_log.SmartSyncOptOutDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SmartSyncOptOutDetails(@javax.annotation.Nonnull SmartSyncOptOutPolicy previousValue, @javax.annotation.Nonnull SmartSyncOptOutPolicy newValue) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SmartSyncOptOutDetails other = (SmartSyncOptOutDetails) obj;
    ...
    static class Serializer extends StructSerializer<SmartSyncOptOutDetails> {
        ...
        @Override
        public void serialize(SmartSyncOptOutDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SmartSyncOptOutDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SmartSyncOptOutDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SmartSyncOptOutDetails(f_previousValue, f_newValue);
            }
            else {
