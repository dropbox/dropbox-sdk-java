...
public class FileTransfersTransferDownloadDetails {
    // struct team_log.FileTransfersTransferDownloadDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileTransfersTransferDownloadDetails other = (FileTransfersTransferDownloadDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<FileTransfersTransferDownloadDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(FileTransfersTransferDownloadDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileTransfersTransferDownloadDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileTransfersTransferDownloadDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileTransfersTransferDownloadDetails(f_fileTransferId);
            }
            else {
