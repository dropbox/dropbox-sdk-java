...
public class MemberProfile {
    ...
    public static class Builder {
        ...
        public MemberProfile build() {
            return new MemberProfile(teamMemberId, email, emailVerified, status, name, membershipType, externalId, accountId, secondaryEmails, invitedOn, joinedOn, suspendedOn, persistentId, isDirectoryRestricted, profilePhotoUrl);
        }
    }
    ...
    static class Serializer extends StructSerializer<MemberProfile> {
        ...
        public MemberProfile deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new MemberProfile(f_teamMemberId, f_email, f_emailVerified, f_status, f_name, f_membershipType, f_externalId, f_accountId, f_secondaryEmails, f_invitedOn, f_joinedOn, f_suspendedOn, f_persistentId, f_isDirectoryRestricted, f_profilePhotoUrl);
            }
            else {
