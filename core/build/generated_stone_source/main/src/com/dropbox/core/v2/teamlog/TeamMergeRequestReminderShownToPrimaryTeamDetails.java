...
public class TeamMergeRequestReminderShownToPrimaryTeamDetails {
    // struct team_log.TeamMergeRequestReminderShownToPrimaryTeamDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public TeamMergeRequestReminderShownToPrimaryTeamDetails(@Nonnull String secondaryTeam, @Nonnull String sentTo) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamMergeRequestReminderShownToPrimaryTeamDetails other = (TeamMergeRequestReminderShownToPrimaryTeamDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamMergeRequestReminderShownToPrimaryTeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamMergeRequestReminderShownToPrimaryTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamMergeRequestReminderShownToPrimaryTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamMergeRequestReminderShownToPrimaryTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamMergeRequestReminderShownToPrimaryTeamDetails(f_secondaryTeam, f_sentTo);
            }
            else {
