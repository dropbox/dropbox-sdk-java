...
public class SharedLinkSettingsChangePasswordDetails {
    // struct team_log.SharedLinkSettingsChangePasswordDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SharedLinkSettingsChangePasswordDetails(@Nonnull AccessLevel sharedContentAccessLevel, @Nullable String sharedContentLink) {
     ...
     *     preconditions.
     */
    public SharedLinkSettingsChangePasswordDetails(@Nonnull AccessLevel sharedContentAccessLevel) {
     ...
     */
    static class Serializer extends StructSerializer<SharedLinkSettingsChangePasswordDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(SharedLinkSettingsChangePasswordDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedLinkSettingsChangePasswordDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SharedLinkSettingsChangePasswordDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
