...
public class TeamMergeRequestSentShownToPrimaryTeamDetails {
    // struct team_log.TeamMergeRequestSentShownToPrimaryTeamDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamMergeRequestSentShownToPrimaryTeamDetails other = (TeamMergeRequestSentShownToPrimaryTeamDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamMergeRequestSentShownToPrimaryTeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamMergeRequestSentShownToPrimaryTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamMergeRequestSentShownToPrimaryTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamMergeRequestSentShownToPrimaryTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamMergeRequestSentShownToPrimaryTeamDetails(f_secondaryTeam, f_sentTo);
            }
            else {
