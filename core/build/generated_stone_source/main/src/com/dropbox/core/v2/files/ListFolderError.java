...
public final class ListFolderError {
    // union files.ListFolderError (files_files_public_types.stone)
    ...
    /**
     *
     * @param templateErrorValue  Must not be {@code null}.
     * @param _tag  Discriminating tag for this instance.
     *
     * @throws IllegalArgumentException  If any argument does not meet its
     *     preconditions.
     ...
     * Tag#TEMPLATE_ERROR}, {@code false} otherwise.
     *
    ...
    /**
     * This instance must be tagged as {@link Tag#TEMPLATE_ERROR}.
     *
     * @return The {@link TemplateError} value associated with this instance if
     *     {@link #isTemplateError} is {@code true}.
     *
     * @throws IllegalStateException  If {@link #isTemplateError} is {@code
     *     false}.
     */
