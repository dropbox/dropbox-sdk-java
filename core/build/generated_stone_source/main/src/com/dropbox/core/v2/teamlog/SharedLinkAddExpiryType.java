...
public class SharedLinkAddExpiryType {
    // struct team_log.SharedLinkAddExpiryType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharedLinkAddExpiryType other = (SharedLinkAddExpiryType) obj;
    ...
    static class Serializer extends StructSerializer<SharedLinkAddExpiryType> {
        ...
        @Override
        public void serialize(SharedLinkAddExpiryType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedLinkAddExpiryType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SharedLinkAddExpiryType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SharedLinkAddExpiryType(f_description);
            }
            else {
