...
public class LegalHoldsChangeHoldDetailsDetails {
    // struct team_log.LegalHoldsChangeHoldDetailsDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     * @param previousValue  Previous details. Must not be {@code null}.
     * @param newValue  New details. Must not be {@code null}.
     *
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            LegalHoldsChangeHoldDetailsDetails other = (LegalHoldsChangeHoldDetailsDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<LegalHoldsChangeHoldDetailsDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(LegalHoldsChangeHoldDetailsDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public LegalHoldsChangeHoldDetailsDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            LegalHoldsChangeHoldDetailsDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new LegalHoldsChangeHoldDetailsDetails(f_legalHoldId, f_name, f_previousValue, f_newValue);
            }
            else {
