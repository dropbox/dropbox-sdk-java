...
public enum LegalHoldsPolicyReleaseError {
    // union team.LegalHoldsPolicyReleaseError (team_team_legal_holds.stone)
    /**
    ...
    static class Serializer extends UnionSerializer<LegalHoldsPolicyReleaseError> {
        ...
        public LegalHoldsPolicyReleaseError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = LegalHoldsPolicyReleaseError.UNKNOWN_LEGAL_HOLD_ERROR;
            }
            else if ("insufficient_permissions".equals(tag)) {
                value = LegalHoldsPolicyReleaseError.INSUFFICIENT_PERMISSIONS;
            }
