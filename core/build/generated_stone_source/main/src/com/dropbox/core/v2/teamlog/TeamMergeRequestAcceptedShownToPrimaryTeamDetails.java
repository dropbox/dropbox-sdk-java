 ...
 */
public class TeamMergeRequestAcceptedShownToPrimaryTeamDetails {
    // struct team_log.TeamMergeRequestAcceptedShownToPrimaryTeamDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public TeamMergeRequestAcceptedShownToPrimaryTeamDetails(@javax.annotation.Nonnull String secondaryTeam, @javax.annotation.Nonnull String sentBy) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamMergeRequestAcceptedShownToPrimaryTeamDetails other = (TeamMergeRequestAcceptedShownToPrimaryTeamDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamMergeRequestAcceptedShownToPrimaryTeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamMergeRequestAcceptedShownToPrimaryTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamMergeRequestAcceptedShownToPrimaryTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamMergeRequestAcceptedShownToPrimaryTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamMergeRequestAcceptedShownToPrimaryTeamDetails(f_secondaryTeam, f_sentBy);
            }
            else {
