...
public class LogoutType {
    // struct team_log.LogoutType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public LogoutType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            LogoutType other = (LogoutType) obj;
    ...
    static class Serializer extends StructSerializer<LogoutType> {
        ...
        @Override
        public void serialize(LogoutType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public LogoutType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            LogoutType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
            ...
            if (tag == null) {
                ...
                value = new LogoutType(f_description);
            }
            else {
