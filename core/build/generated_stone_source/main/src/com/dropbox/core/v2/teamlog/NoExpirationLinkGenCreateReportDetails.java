...
public class NoExpirationLinkGenCreateReportDetails {
    // struct team_log.NoExpirationLinkGenCreateReportDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public NoExpirationLinkGenCreateReportDetails(@Nonnull Date startDate, @Nonnull Date endDate) {
        if (startDate == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            NoExpirationLinkGenCreateReportDetails other = (NoExpirationLinkGenCreateReportDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<NoExpirationLinkGenCreateReportDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(NoExpirationLinkGenCreateReportDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public NoExpirationLinkGenCreateReportDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            NoExpirationLinkGenCreateReportDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new NoExpirationLinkGenCreateReportDetails(f_startDate, f_endDate);
            }
            else {
