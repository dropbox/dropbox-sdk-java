...
class TeamFolderListContinueArg {
    // struct team.TeamFolderListContinueArg (team_team_folders.stone)
     ...
     *     preconditions.
     */
    public TeamFolderListContinueArg(@Nonnull String cursor) {
        if (cursor == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamFolderListContinueArg other = (TeamFolderListContinueArg) obj;
    ...
    static class Serializer extends StructSerializer<TeamFolderListContinueArg> {
        ...
        @Override
        public void serialize(TeamFolderListContinueArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamFolderListContinueArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamFolderListContinueArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamFolderListContinueArg(f_cursor);
            }
            else {
