...
public class SfTeamInviteDetails {
     ...
     *     preconditions.
     */
    public SfTeamInviteDetails(long targetAssetIndex, @javax.annotation.Nonnull String originalFolderName, @javax.annotation.Nullable String sharingPermission) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SfTeamInviteDetails other = (SfTeamInviteDetails) obj;
    ...
    static class Serializer extends StructSerializer<SfTeamInviteDetails> {
        ...
        @Override
        public void serialize(SfTeamInviteDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SfTeamInviteDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SfTeamInviteDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SfTeamInviteDetails(f_targetAssetIndex, f_originalFolderName, f_sharingPermission);
            }
            else {
