...
public class TfaAddBackupPhoneType {
    // struct team_log.TfaAddBackupPhoneType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TfaAddBackupPhoneType other = (TfaAddBackupPhoneType) obj;
    ...
    static class Serializer extends StructSerializer<TfaAddBackupPhoneType> {
        ...
        @Override
        public void serialize(TfaAddBackupPhoneType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TfaAddBackupPhoneType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TfaAddBackupPhoneType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TfaAddBackupPhoneType(f_description);
            }
            else {
