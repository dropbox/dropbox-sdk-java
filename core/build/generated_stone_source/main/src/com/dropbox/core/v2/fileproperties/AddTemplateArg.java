...
public class AddTemplateArg extends PropertyGroupTemplate {
    // struct file_properties.AddTemplateArg (file_properties_apiv2_file_properties_types.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            AddTemplateArg other = (AddTemplateArg) obj;
    ...
    public static class Serializer extends StructSerializer<AddTemplateArg> {
        ...
        @Override
        public void serialize(AddTemplateArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public AddTemplateArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            AddTemplateArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new AddTemplateArg(f_name, f_description, f_fields);
            }
            else {
