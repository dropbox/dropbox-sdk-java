...
public class LoginSuccessType {
    // struct team_log.LoginSuccessType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            LoginSuccessType other = (LoginSuccessType) obj;
    ...
    static class Serializer extends StructSerializer<LoginSuccessType> {
        ...
        @Override
        public void serialize(LoginSuccessType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public LoginSuccessType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            LoginSuccessType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new LoginSuccessType(f_description);
            }
            else {
