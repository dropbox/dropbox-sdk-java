...
public class TeamMergeRequestAcceptedShownToSecondaryTeamDetails {
    // struct team_log.TeamMergeRequestAcceptedShownToSecondaryTeamDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamMergeRequestAcceptedShownToSecondaryTeamDetails other = (TeamMergeRequestAcceptedShownToSecondaryTeamDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamMergeRequestAcceptedShownToSecondaryTeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamMergeRequestAcceptedShownToSecondaryTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamMergeRequestAcceptedShownToSecondaryTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamMergeRequestAcceptedShownToSecondaryTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamMergeRequestAcceptedShownToSecondaryTeamDetails(f_primaryTeam, f_sentBy);
            }
            else {
