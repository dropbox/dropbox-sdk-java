...
public class TeamMergeRequestRejectedShownToPrimaryTeamDetails {
    // struct team_log.TeamMergeRequestRejectedShownToPrimaryTeamDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public TeamMergeRequestRejectedShownToPrimaryTeamDetails(@javax.annotation.Nonnull String secondaryTeam, @javax.annotation.Nonnull String sentBy) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamMergeRequestRejectedShownToPrimaryTeamDetails other = (TeamMergeRequestRejectedShownToPrimaryTeamDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamMergeRequestRejectedShownToPrimaryTeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamMergeRequestRejectedShownToPrimaryTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamMergeRequestRejectedShownToPrimaryTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamMergeRequestRejectedShownToPrimaryTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamMergeRequestRejectedShownToPrimaryTeamDetails(f_secondaryTeam, f_sentBy);
            }
            else {
