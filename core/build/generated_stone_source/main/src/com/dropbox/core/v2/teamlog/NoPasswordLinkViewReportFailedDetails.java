...
public class NoPasswordLinkViewReportFailedDetails {
    // struct team_log.NoPasswordLinkViewReportFailedDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            NoPasswordLinkViewReportFailedDetails other = (NoPasswordLinkViewReportFailedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<NoPasswordLinkViewReportFailedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(NoPasswordLinkViewReportFailedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public NoPasswordLinkViewReportFailedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            NoPasswordLinkViewReportFailedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new NoPasswordLinkViewReportFailedDetails(f_failureReason);
            }
            else {
