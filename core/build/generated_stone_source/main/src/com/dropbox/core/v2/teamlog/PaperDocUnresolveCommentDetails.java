...
public class PaperDocUnresolveCommentDetails {
    // struct team_log.PaperDocUnresolveCommentDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocUnresolveCommentDetails(@Nonnull String eventUuid, @Nullable String commentText) {
        if (eventUuid == null) {
     ...
     *     preconditions.
     */
    public PaperDocUnresolveCommentDetails(@Nonnull String eventUuid) {
        this(eventUuid, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocUnresolveCommentDetails other = (PaperDocUnresolveCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocUnresolveCommentDetails> {
        ...
        @Override
        public void serialize(PaperDocUnresolveCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocUnresolveCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocUnresolveCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocUnresolveCommentDetails(f_eventUuid, f_commentText);
            }
            else {
