...
public class ShowcaseFileRemovedDetails {
    // struct team_log.ShowcaseFileRemovedDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ShowcaseFileRemovedDetails(@Nonnull String eventUuid) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcaseFileRemovedDetails other = (ShowcaseFileRemovedDetails) obj;
    ...
    static class Serializer extends StructSerializer<ShowcaseFileRemovedDetails> {
        ...
        @Override
        public void serialize(ShowcaseFileRemovedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcaseFileRemovedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShowcaseFileRemovedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShowcaseFileRemovedDetails(f_eventUuid);
            }
            else {
