...
public class NoPasswordLinkViewCreateReportDetails {
    // struct team_log.NoPasswordLinkViewCreateReportDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public NoPasswordLinkViewCreateReportDetails(@Nonnull Date startDate, @Nonnull Date endDate) {
        if (startDate == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            NoPasswordLinkViewCreateReportDetails other = (NoPasswordLinkViewCreateReportDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<NoPasswordLinkViewCreateReportDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(NoPasswordLinkViewCreateReportDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public NoPasswordLinkViewCreateReportDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            NoPasswordLinkViewCreateReportDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new NoPasswordLinkViewCreateReportDetails(f_startDate, f_endDate);
            }
            else {
