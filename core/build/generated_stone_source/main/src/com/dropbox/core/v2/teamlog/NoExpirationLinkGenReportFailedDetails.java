...
public class NoExpirationLinkGenReportFailedDetails {
    // struct team_log.NoExpirationLinkGenReportFailedDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            NoExpirationLinkGenReportFailedDetails other = (NoExpirationLinkGenReportFailedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<NoExpirationLinkGenReportFailedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(NoExpirationLinkGenReportFailedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public NoExpirationLinkGenReportFailedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            NoExpirationLinkGenReportFailedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new NoExpirationLinkGenReportFailedDetails(f_failureReason);
            }
            else {
