...
public class PaperDocRevertDetails {
    // struct team_log.PaperDocRevertDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocRevertDetails(@Nonnull String eventUuid) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocRevertDetails other = (PaperDocRevertDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocRevertDetails> {
        ...
        @Override
        public void serialize(PaperDocRevertDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocRevertDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocRevertDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocRevertDetails(f_eventUuid);
            }
            else {
