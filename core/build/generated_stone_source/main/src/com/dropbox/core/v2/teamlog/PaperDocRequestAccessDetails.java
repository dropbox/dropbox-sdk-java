...
public class PaperDocRequestAccessDetails {
    // struct team_log.PaperDocRequestAccessDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocRequestAccessDetails(@Nonnull String eventUuid) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocRequestAccessDetails other = (PaperDocRequestAccessDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocRequestAccessDetails> {
        ...
        @Override
        public void serialize(PaperDocRequestAccessDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocRequestAccessDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocRequestAccessDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocRequestAccessDetails(f_eventUuid);
            }
            else {
