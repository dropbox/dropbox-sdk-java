...
public class FileLock {
    // struct files.FileLock (files_files_public_base.stone)
    ...
    /**
     *
     * @param content  The lock description. Must not be {@code null}.
     *
     ...
     */
    static class Serializer extends StructSerializer<FileLock> {
        ...
        public FileLock deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                FileLockContent f_content = null;
