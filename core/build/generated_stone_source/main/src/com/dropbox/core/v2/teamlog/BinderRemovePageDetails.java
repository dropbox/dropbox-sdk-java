...
public class BinderRemovePageDetails {
    // struct team_log.BinderRemovePageDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            BinderRemovePageDetails other = (BinderRemovePageDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<BinderRemovePageDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(BinderRemovePageDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public BinderRemovePageDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            BinderRemovePageDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new BinderRemovePageDetails(f_eventUuid, f_docTitle, f_binderItemName);
            }
            else {
