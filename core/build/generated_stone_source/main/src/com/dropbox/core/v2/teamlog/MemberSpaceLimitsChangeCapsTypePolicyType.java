...
public class MemberSpaceLimitsChangeCapsTypePolicyType {
    // struct team_log.MemberSpaceLimitsChangeCapsTypePolicyType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public MemberSpaceLimitsChangeCapsTypePolicyType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            MemberSpaceLimitsChangeCapsTypePolicyType other = (MemberSpaceLimitsChangeCapsTypePolicyType) obj;
    ...
    static class Serializer extends StructSerializer<MemberSpaceLimitsChangeCapsTypePolicyType> {
        ...
        @Override
        public void serialize(MemberSpaceLimitsChangeCapsTypePolicyType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public MemberSpaceLimitsChangeCapsTypePolicyType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new MemberSpaceLimitsChangeCapsTypePolicyType(f_description);
            }
            else {
