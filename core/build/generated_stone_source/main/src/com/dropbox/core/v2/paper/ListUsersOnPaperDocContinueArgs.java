...
class ListUsersOnPaperDocContinueArgs extends RefPaperDoc {
    // struct paper.ListUsersOnPaperDocContinueArgs (paper_apiv2_paper_types.stone)
     ...
     *     preconditions.
     */
    public ListUsersOnPaperDocContinueArgs(@Nonnull String docId, @Nonnull String cursor) {
        super(docId);
        if (cursor == null) {
     ...
     * DbxUserPaperRequests#docsUsersList(String)} or {@link
     * DbxUserPaperRequests#docsUsersListContinue(String,String)}. Allows for
     * pagination.
     *
     * @return value for this field, never {@code null}.
     */
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ListUsersOnPaperDocContinueArgs other = (ListUsersOnPaperDocContinueArgs) obj;
    ...
    static class Serializer extends StructSerializer<ListUsersOnPaperDocContinueArgs> {
        ...
        @Override
        public void serialize(ListUsersOnPaperDocContinueArgs value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ListUsersOnPaperDocContinueArgs deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ListUsersOnPaperDocContinueArgs value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ListUsersOnPaperDocContinueArgs(f_docId, f_cursor);
            }
            else {
