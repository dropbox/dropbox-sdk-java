...
public class DeleteSecondaryEmailsResult {
    // struct team.DeleteSecondaryEmailsResult (team_apiv2_team_members_secondary_emails.stone)
     ...
     *     preconditions.
     */
    public DeleteSecondaryEmailsResult(@Nonnull List<UserDeleteResult> results) {
        if (results == null) {
