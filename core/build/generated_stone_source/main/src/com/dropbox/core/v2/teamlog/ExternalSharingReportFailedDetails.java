...
public class ExternalSharingReportFailedDetails {
    // struct team_log.ExternalSharingReportFailedDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ExternalSharingReportFailedDetails other = (ExternalSharingReportFailedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<ExternalSharingReportFailedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(ExternalSharingReportFailedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ExternalSharingReportFailedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ExternalSharingReportFailedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ExternalSharingReportFailedDetails(f_failureReason);
            }
            else {
