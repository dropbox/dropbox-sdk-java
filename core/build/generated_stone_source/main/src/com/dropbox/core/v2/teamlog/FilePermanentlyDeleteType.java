...
public class FilePermanentlyDeleteType {
    // struct team_log.FilePermanentlyDeleteType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public FilePermanentlyDeleteType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FilePermanentlyDeleteType other = (FilePermanentlyDeleteType) obj;
    ...
    static class Serializer extends StructSerializer<FilePermanentlyDeleteType> {
        ...
        @Override
        public void serialize(FilePermanentlyDeleteType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FilePermanentlyDeleteType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FilePermanentlyDeleteType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FilePermanentlyDeleteType(f_description);
            }
            else {
