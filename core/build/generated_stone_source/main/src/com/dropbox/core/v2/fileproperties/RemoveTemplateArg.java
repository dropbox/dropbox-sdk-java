...
class RemoveTemplateArg {
    // struct file_properties.RemoveTemplateArg (file_properties_apiv2_file_properties_types.stone)
    ...
    /**
     * An identifier for a template created by {@link
     * DbxUserFilePropertiesRequests#templatesAddForUser(String,String,java.util.List)}
     * or {@link
     * DbxTeamFilePropertiesRequests#templatesAddForTeam(String,String,java.util.List)}.
     *
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            RemoveTemplateArg other = (RemoveTemplateArg) obj;
    ...
    static class Serializer extends StructSerializer<RemoveTemplateArg> {
        ...
        @Override
        public void serialize(RemoveTemplateArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public RemoveTemplateArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            RemoveTemplateArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new RemoveTemplateArg(f_templateId);
            }
            else {
