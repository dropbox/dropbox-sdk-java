...
public class ShowcaseEditCommentDetails {
    // struct team_log.ShowcaseEditCommentDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ShowcaseEditCommentDetails(@Nonnull String eventUuid, @Nullable String commentText) {
        if (eventUuid == null) {
     ...
     *     preconditions.
     */
    public ShowcaseEditCommentDetails(@Nonnull String eventUuid) {
        this(eventUuid, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcaseEditCommentDetails other = (ShowcaseEditCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<ShowcaseEditCommentDetails> {
        ...
        @Override
        public void serialize(ShowcaseEditCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcaseEditCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShowcaseEditCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShowcaseEditCommentDetails(f_eventUuid, f_commentText);
            }
            else {
