...
public class SfFbUninviteDetails {
    // struct team_log.SfFbUninviteDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SfFbUninviteDetails other = (SfFbUninviteDetails) obj;
    ...
    static class Serializer extends StructSerializer<SfFbUninviteDetails> {
        ...
        @Override
        public void serialize(SfFbUninviteDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SfFbUninviteDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SfFbUninviteDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SfFbUninviteDetails(f_targetAssetIndex, f_originalFolderName);
            }
            else {
