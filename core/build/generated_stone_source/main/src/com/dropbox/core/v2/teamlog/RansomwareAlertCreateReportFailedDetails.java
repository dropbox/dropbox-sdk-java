...
public class RansomwareAlertCreateReportFailedDetails {
    // struct team_log.RansomwareAlertCreateReportFailedDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            RansomwareAlertCreateReportFailedDetails other = (RansomwareAlertCreateReportFailedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<RansomwareAlertCreateReportFailedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(RansomwareAlertCreateReportFailedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public RansomwareAlertCreateReportFailedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            RansomwareAlertCreateReportFailedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new RansomwareAlertCreateReportFailedDetails(f_failureReason);
            }
            else {
