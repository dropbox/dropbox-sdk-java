...
public class DeviceLinkSuccessType {
    // struct team_log.DeviceLinkSuccessType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            DeviceLinkSuccessType other = (DeviceLinkSuccessType) obj;
    ...
    static class Serializer extends StructSerializer<DeviceLinkSuccessType> {
        ...
        @Override
        public void serialize(DeviceLinkSuccessType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DeviceLinkSuccessType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            DeviceLinkSuccessType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new DeviceLinkSuccessType(f_description);
            }
            else {
