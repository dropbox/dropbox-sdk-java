...
public class SharedLinkSettingsAllowDownloadDisabledDetails {
    // struct team_log.SharedLinkSettingsAllowDownloadDisabledDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SharedLinkSettingsAllowDownloadDisabledDetails(@Nonnull AccessLevel sharedContentAccessLevel, @Nullable String sharedContentLink) {
     ...
     *     preconditions.
     */
    public SharedLinkSettingsAllowDownloadDisabledDetails(@Nonnull AccessLevel sharedContentAccessLevel) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharedLinkSettingsAllowDownloadDisabledDetails other = (SharedLinkSettingsAllowDownloadDisabledDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<SharedLinkSettingsAllowDownloadDisabledDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(SharedLinkSettingsAllowDownloadDisabledDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedLinkSettingsAllowDownloadDisabledDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new SharedLinkSettingsAllowDownloadDisabledDetails(f_sharedContentAccessLevel, f_sharedContentLink);
            }
            else {
