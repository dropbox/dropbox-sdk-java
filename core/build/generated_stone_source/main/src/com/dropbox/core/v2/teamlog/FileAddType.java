...
public class FileAddType {
    // struct team_log.FileAddType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public FileAddType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileAddType other = (FileAddType) obj;
    ...
    static class Serializer extends StructSerializer<FileAddType> {
        ...
        @Override
        public void serialize(FileAddType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileAddType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileAddType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
            ...
            if (tag == null) {
                ...
                value = new FileAddType(f_description);
            }
            else {
