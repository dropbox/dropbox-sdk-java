...
public class SharedContentDownloadDetails {
    // struct team_log.SharedContentDownloadDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharedContentDownloadDetails other = (SharedContentDownloadDetails) obj;
    ...
    static class Serializer extends StructSerializer<SharedContentDownloadDetails> {
        ...
        @Override
        public void serialize(SharedContentDownloadDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedContentDownloadDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SharedContentDownloadDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SharedContentDownloadDetails(f_sharedContentLink, f_sharedContentAccessLevel, f_sharedContentOwner);
            }
            else {
