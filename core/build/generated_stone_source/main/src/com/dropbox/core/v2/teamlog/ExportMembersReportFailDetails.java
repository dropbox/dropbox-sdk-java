...
public class ExportMembersReportFailDetails {
    // struct team_log.ExportMembersReportFailDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ExportMembersReportFailDetails(@Nonnull TeamReportFailureReason failureReason) {
