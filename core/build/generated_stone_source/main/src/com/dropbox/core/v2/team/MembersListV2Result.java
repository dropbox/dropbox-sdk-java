...
public class MembersListV2Result {
    // struct team.MembersListV2Result (team_team_members_types.stone)
     ...
     *     preconditions.
     */
    public MembersListV2Result(@Nonnull List<TeamMemberInfoV2> members, @Nonnull String cursor, boolean hasMore) {
        if (members == null) {
