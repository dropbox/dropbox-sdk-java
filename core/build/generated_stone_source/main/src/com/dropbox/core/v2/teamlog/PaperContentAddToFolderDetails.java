...
public class PaperContentAddToFolderDetails {
    // struct team_log.PaperContentAddToFolderDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperContentAddToFolderDetails other = (PaperContentAddToFolderDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperContentAddToFolderDetails> {
        ...
        @Override
        public void serialize(PaperContentAddToFolderDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperContentAddToFolderDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperContentAddToFolderDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperContentAddToFolderDetails(f_eventUuid, f_targetAssetIndex, f_parentAssetIndex);
            }
            else {
