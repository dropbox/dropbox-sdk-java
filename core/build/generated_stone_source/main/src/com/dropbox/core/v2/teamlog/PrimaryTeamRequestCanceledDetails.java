...
public class PrimaryTeamRequestCanceledDetails {
    // struct team_log.PrimaryTeamRequestCanceledDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PrimaryTeamRequestCanceledDetails(@Nonnull String secondaryTeam, @Nonnull String sentBy) {
