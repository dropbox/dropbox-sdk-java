...
public class PrimaryTeamRequestCanceledDetails {
    // struct team_log.PrimaryTeamRequestCanceledDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PrimaryTeamRequestCanceledDetails(@javax.annotation.Nonnull String secondaryTeam, @javax.annotation.Nonnull String sentBy) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PrimaryTeamRequestCanceledDetails other = (PrimaryTeamRequestCanceledDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<PrimaryTeamRequestCanceledDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(PrimaryTeamRequestCanceledDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PrimaryTeamRequestCanceledDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PrimaryTeamRequestCanceledDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PrimaryTeamRequestCanceledDetails(f_secondaryTeam, f_sentBy);
            }
            else {
