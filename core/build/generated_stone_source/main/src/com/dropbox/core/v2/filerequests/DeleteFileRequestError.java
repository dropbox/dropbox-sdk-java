 ...
 */
public enum DeleteFileRequestError {
    // union file_requests.DeleteFileRequestError (file_requests_apiv2_file_requests_public.stone)
    /**
     ...
     */
    static class Serializer extends UnionSerializer<DeleteFileRequestError> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(DeleteFileRequestError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (value) {
                ...
                case FILE_REQUEST_OPEN: {
                    g.writeString("file_request_open");
                    break;
                }
                default: {
        ...
        @Override
        public DeleteFileRequestError deserialize(JsonParser p) throws IOException, JsonParseException {
            DeleteFileRequestError value;
            boolean collapsed;
            String tag;
            ...
            if (tag == null) {
                ...
                value = DeleteFileRequestError.DISABLED_FOR_TEAM;
            }
            else if ("other".equals(tag)) {
                value = DeleteFileRequestError.OTHER;
            }
            else if ("not_found".equals(tag)) {
                value = DeleteFileRequestError.NOT_FOUND;
            }
            else if ("not_a_folder".equals(tag)) {
                value = DeleteFileRequestError.NOT_A_FOLDER;
            }
            else if ("app_lacks_access".equals(tag)) {
                value = DeleteFileRequestError.APP_LACKS_ACCESS;
            }
            else if ("no_permission".equals(tag)) {
                value = DeleteFileRequestError.NO_PERMISSION;
            }
            else if ("email_unverified".equals(tag)) {
                value = DeleteFileRequestError.EMAIL_UNVERIFIED;
            }
