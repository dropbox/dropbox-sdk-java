...
public class ClassificationChangePolicyType {
    // struct team_log.ClassificationChangePolicyType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ClassificationChangePolicyType other = (ClassificationChangePolicyType) obj;
     ...
     */
    static class Serializer extends StructSerializer<ClassificationChangePolicyType> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(ClassificationChangePolicyType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ClassificationChangePolicyType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new ClassificationChangePolicyType(f_description);
            }
            else {
