...
/**
 * Result returned by {@link DbxUserFilesRequests#deleteBatch(java.util.List)}
...
public final class DeleteBatchLaunch {
    // union files.DeleteBatchLaunch (files_files_public_types.stone)

    /**
     * Discriminating tag type for {@link DeleteBatchLaunch}.
     */
    public enum Tag {
        /**
     ...
     * DbxUserFilesRequests#deleteBatch(java.util.List)} that may either launch
     * an asynchronous job or complete synchronously.
     *
     * @param _tag  Discriminating tag for this instance.
     */
    private DeleteBatchLaunch withTag(Tag _tag) {
        DeleteBatchLaunch result = new DeleteBatchLaunch();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private DeleteBatchLaunch withTagAndAsyncJobId(Tag _tag, String asyncJobIdValue) {
        DeleteBatchLaunch result = new DeleteBatchLaunch();
        result._tag = _tag;
     ...
     *     preconditions.
     */
    private DeleteBatchLaunch withTagAndComplete(Tag _tag, DeleteBatchResult completeValue) {
        DeleteBatchLaunch result = new DeleteBatchLaunch();
        result._tag = _tag;
     ...
     * values for this {@code DeleteBatchLaunch}. </p>
     *
    ...
    /**
     * Returns an instance of {@code DeleteBatchLaunch} that has its tag set to
     ...
     *
     * @return Instance of {@code DeleteBatchLaunch} with its tag set to {@link
     *     Tag#ASYNC_JOB_ID}.
     *
    ...
    public static DeleteBatchLaunch asyncJobId(String value) {
        ...
        return new DeleteBatchLaunch().withTagAndAsyncJobId(Tag.ASYNC_JOB_ID, value);
    }
    ...
    public static DeleteBatchLaunch complete(DeleteBatchResult value) {
        ...
        return new DeleteBatchLaunch().withTagAndComplete(Tag.COMPLETE, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        else if (obj instanceof DeleteBatchLaunch) {
