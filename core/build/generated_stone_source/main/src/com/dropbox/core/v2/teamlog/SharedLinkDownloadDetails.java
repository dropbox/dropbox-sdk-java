...
public class SharedLinkDownloadDetails {
    // struct team_log.SharedLinkDownloadDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharedLinkDownloadDetails other = (SharedLinkDownloadDetails) obj;
    ...
    static class Serializer extends StructSerializer<SharedLinkDownloadDetails> {
        ...
        @Override
        public void serialize(SharedLinkDownloadDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedLinkDownloadDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SharedLinkDownloadDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SharedLinkDownloadDetails(f_sharedLinkOwner);
            }
            else {
