...
public class AppUnlinkTeamDetails {
    // struct team_log.AppUnlinkTeamDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            AppUnlinkTeamDetails other = (AppUnlinkTeamDetails) obj;
    ...
    static class Serializer extends StructSerializer<AppUnlinkTeamDetails> {
        ...
        @Override
        public void serialize(AppUnlinkTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public AppUnlinkTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            AppUnlinkTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new AppUnlinkTeamDetails(f_appInfo);
            }
            else {
