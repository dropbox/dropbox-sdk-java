...
public class SharingAllowlistRemoveBuilder {
     ...
     */
    SharingAllowlistRemoveBuilder(DbxTeamTeamRequests _client, SharingAllowlistRemoveArgs.Builder _builder) {
        if (_client == null) {
     ...
     *     preconditions.
     */
    public SharingAllowlistRemoveBuilder withDomains(List<String> domains) {
     ...
     *     preconditions.
     */
    public SharingAllowlistRemoveBuilder withEmails(List<String> emails) {
    ...
    public SharingAllowlistRemoveResponse start() throws SharingAllowlistRemoveErrorException, DbxException {
        SharingAllowlistRemoveArgs arg_ = this._builder.build();
        return _client.sharingAllowlistRemove(arg_);
    }
}
