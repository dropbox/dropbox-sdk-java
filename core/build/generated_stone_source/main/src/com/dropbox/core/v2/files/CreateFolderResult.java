...
public class CreateFolderResult extends FileOpsResult {
     ...
     *     preconditions.
     */
    public CreateFolderResult(@javax.annotation.Nonnull FolderMetadata metadata) {
        if (metadata == null) {
    ...
    static class Serializer extends StructSerializer<CreateFolderResult> {
        ...
        @Override
        public void serialize(CreateFolderResult value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public CreateFolderResult deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new CreateFolderResult(f_metadata);
            }
            else {
