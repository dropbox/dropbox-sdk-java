 ...
 * DbxUserFilesRequests#uploadSessionFinishBatch(java.util.List)} that may
...
public final class UploadSessionFinishBatchLaunch {
    // union files.UploadSessionFinishBatchLaunch (files_files_public_types.stone)

    /**
     * Discriminating tag type for {@link UploadSessionFinishBatchLaunch}.
     */
    public enum Tag {
        /**
     ...
     */
    private UploadSessionFinishBatchLaunch withTag(Tag _tag) {
        UploadSessionFinishBatchLaunch result = new UploadSessionFinishBatchLaunch();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private UploadSessionFinishBatchLaunch withTagAndComplete(Tag _tag, UploadSessionFinishBatchResult completeValue) {
        UploadSessionFinishBatchLaunch result = new UploadSessionFinishBatchLaunch();
        result._tag = _tag;
     ...
     * values for this {@code UploadSessionFinishBatchLaunch}. </p>
     *
    ...
    /**
     * Returns an instance of {@code UploadSessionFinishBatchLaunch} that has
     * its tag set to {@link Tag#ASYNC_JOB_ID}.
     *
     ...
     *
     * @return Instance of {@code UploadSessionFinishBatchLaunch} with its tag
    ...
    public static UploadSessionFinishBatchLaunch asyncJobId(String value) {
        ...
        return new UploadSessionFinishBatchLaunch().withTagAndAsyncJobId(Tag.ASYNC_JOB_ID, value);
    }
    ...
    public static UploadSessionFinishBatchLaunch complete(UploadSessionFinishBatchResult value) {
        ...
        return new UploadSessionFinishBatchLaunch().withTagAndComplete(Tag.COMPLETE, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        else if (obj instanceof UploadSessionFinishBatchLaunch) {
    ...
    static class Serializer extends UnionSerializer<UploadSessionFinishBatchLaunch> {
        ...
        public UploadSessionFinishBatchLaunch deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = UploadSessionFinishBatchLaunch.asyncJobId(fieldValue);
            }
                ...
                value = UploadSessionFinishBatchLaunch.complete(fieldValue);
            }
            else {
