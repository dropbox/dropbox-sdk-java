...
public final class WriteError {
    // union files.WriteError (files_files_public_base.stone)
     ...
     * This file operation is not allowed at this path.
     */
    public static final WriteError OPERATION_SUPPRESSED = new WriteError().withTag(Tag.OPERATION_SUPPRESSED);
    /**
    ...
    /**
     * Returns {@code true} if this instance has the tag {@link
     * Tag#OPERATION_SUPPRESSED}, {@code false} otherwise.
     *
     * @return {@code true} if this instance is tagged as {@link
     *     Tag#OPERATION_SUPPRESSED}, {@code false} otherwise.
     */
    public boolean isOperationSuppressed() {
        return this._tag == Tag.OPERATION_SUPPRESSED;
    }
    ...
    static class Serializer extends UnionSerializer<WriteError> {
        ...
        public void serialize(WriteError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (value.tag()) {
                ...
                case OPERATION_SUPPRESSED: {
                    g.writeString("operation_suppressed");
                    break;
                }
                case TOO_MANY_WRITE_OPERATIONS: {
        ...
        public WriteError deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            else if ("operation_suppressed".equals(tag)) {
                value = WriteError.OPERATION_SUPPRESSED;
            }
