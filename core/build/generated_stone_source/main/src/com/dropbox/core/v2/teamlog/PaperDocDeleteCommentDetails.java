...
public class PaperDocDeleteCommentDetails {
     ...
     *     preconditions.
     */
    public PaperDocDeleteCommentDetails(@javax.annotation.Nonnull String eventUuid, @javax.annotation.Nullable String commentText) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocDeleteCommentDetails other = (PaperDocDeleteCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocDeleteCommentDetails> {
        ...
        @Override
        public void serialize(PaperDocDeleteCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocDeleteCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocDeleteCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocDeleteCommentDetails(f_eventUuid, f_commentText);
            }
            else {
