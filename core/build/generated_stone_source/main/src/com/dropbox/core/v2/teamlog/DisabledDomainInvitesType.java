...
public class DisabledDomainInvitesType {
    // struct team_log.DisabledDomainInvitesType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public DisabledDomainInvitesType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            DisabledDomainInvitesType other = (DisabledDomainInvitesType) obj;
    ...
    static class Serializer extends StructSerializer<DisabledDomainInvitesType> {
        ...
        @Override
        public void serialize(DisabledDomainInvitesType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DisabledDomainInvitesType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            DisabledDomainInvitesType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new DisabledDomainInvitesType(f_description);
            }
            else {
