...
public final class RelocationError {
    // union files.RelocationError (files_files_public_types.stone)
     ...
     *     preconditions.
     */
    private RelocationError withTagAndCantMoveIntoFamily(Tag _tag, MoveIntoFamilyError cantMoveIntoFamilyValue) {
        RelocationError result = new RelocationError();
        result._tag = _tag;
     ...
     * @throws IllegalArgumentException  if {@code value} is {@code null}.
     */
    public static RelocationError cantMoveIntoFamily(MoveIntoFamilyError value) {
        if (value == null) {
            throw new IllegalArgumentException("Value is null");
        }
        return new RelocationError().withTagAndCantMoveIntoFamily(Tag.CANT_MOVE_INTO_FAMILY, value);
    }
