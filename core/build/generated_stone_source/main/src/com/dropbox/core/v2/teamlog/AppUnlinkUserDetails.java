...
public class AppUnlinkUserDetails {
    // struct team_log.AppUnlinkUserDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public AppUnlinkUserDetails(@Nonnull AppLogInfo appInfo) {
        if (appInfo == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            AppUnlinkUserDetails other = (AppUnlinkUserDetails) obj;
    ...
    static class Serializer extends StructSerializer<AppUnlinkUserDetails> {
        ...
        @Override
        public void serialize(AppUnlinkUserDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public AppUnlinkUserDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            AppUnlinkUserDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new AppUnlinkUserDetails(f_appInfo);
            }
            else {
