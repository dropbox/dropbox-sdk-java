...
public class ShowcaseUntrashedDeprecatedDetails {
    // struct team_log.ShowcaseUntrashedDeprecatedDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcaseUntrashedDeprecatedDetails other = (ShowcaseUntrashedDeprecatedDetails) obj;
    ...
    static class Serializer extends StructSerializer<ShowcaseUntrashedDeprecatedDetails> {
        ...
        @Override
        public void serialize(ShowcaseUntrashedDeprecatedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcaseUntrashedDeprecatedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShowcaseUntrashedDeprecatedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShowcaseUntrashedDeprecatedDetails(f_eventUuid);
            }
            else {
