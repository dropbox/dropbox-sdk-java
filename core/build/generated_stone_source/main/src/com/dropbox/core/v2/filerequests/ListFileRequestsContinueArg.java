...
class ListFileRequestsContinueArg {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ListFileRequestsContinueArg other = (ListFileRequestsContinueArg) obj;
     ...
     */
    static class Serializer extends StructSerializer<ListFileRequestsContinueArg> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(ListFileRequestsContinueArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ListFileRequestsContinueArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ListFileRequestsContinueArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ListFileRequestsContinueArg(f_cursor);
            }
            else {
