...
public class ClassificationCreateReportFailDetails {
    // struct team_log.ClassificationCreateReportFailDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ClassificationCreateReportFailDetails(@Nonnull TeamReportFailureReason failureReason) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ClassificationCreateReportFailDetails other = (ClassificationCreateReportFailDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<ClassificationCreateReportFailDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(ClassificationCreateReportFailDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ClassificationCreateReportFailDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ClassificationCreateReportFailDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ClassificationCreateReportFailDetails(f_failureReason);
            }
            else {
