...
public class EndedEnterpriseAdminSessionDeprecatedDetails {
    // struct team_log.EndedEnterpriseAdminSessionDeprecatedDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            EndedEnterpriseAdminSessionDeprecatedDetails other = (EndedEnterpriseAdminSessionDeprecatedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<EndedEnterpriseAdminSessionDeprecatedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(EndedEnterpriseAdminSessionDeprecatedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public EndedEnterpriseAdminSessionDeprecatedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            EndedEnterpriseAdminSessionDeprecatedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new EndedEnterpriseAdminSessionDeprecatedDetails(f_federationExtraDetails);
            }
            else {
