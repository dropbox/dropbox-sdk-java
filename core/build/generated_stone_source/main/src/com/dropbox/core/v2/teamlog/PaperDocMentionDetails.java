...
public class PaperDocMentionDetails {
    // struct team_log.PaperDocMentionDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocMentionDetails other = (PaperDocMentionDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocMentionDetails> {
        ...
        @Override
        public void serialize(PaperDocMentionDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocMentionDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocMentionDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocMentionDetails(f_eventUuid);
            }
            else {
