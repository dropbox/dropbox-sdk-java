...
public class SfExternalInviteWarnType {
    // struct team_log.SfExternalInviteWarnType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SfExternalInviteWarnType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SfExternalInviteWarnType other = (SfExternalInviteWarnType) obj;
    ...
    static class Serializer extends StructSerializer<SfExternalInviteWarnType> {
        ...
        @Override
        public void serialize(SfExternalInviteWarnType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SfExternalInviteWarnType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SfExternalInviteWarnType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SfExternalInviteWarnType(f_description);
            }
            else {
