...
public class SfTeamUninviteDetails {
    // struct team_log.SfTeamUninviteDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SfTeamUninviteDetails other = (SfTeamUninviteDetails) obj;
    ...
    static class Serializer extends StructSerializer<SfTeamUninviteDetails> {
        ...
        @Override
        public void serialize(SfTeamUninviteDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SfTeamUninviteDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SfTeamUninviteDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SfTeamUninviteDetails(f_targetAssetIndex, f_originalFolderName);
            }
            else {
