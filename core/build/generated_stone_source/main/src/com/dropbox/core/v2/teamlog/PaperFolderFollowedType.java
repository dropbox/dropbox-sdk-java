...
public class PaperFolderFollowedType {
    // struct team_log.PaperFolderFollowedType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperFolderFollowedType other = (PaperFolderFollowedType) obj;
    ...
    static class Serializer extends StructSerializer<PaperFolderFollowedType> {
        ...
        @Override
        public void serialize(PaperFolderFollowedType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperFolderFollowedType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperFolderFollowedType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperFolderFollowedType(f_description);
            }
            else {
