...
public class UserDeleteEmailsResult {
     ...
     *     preconditions.
     */
    public UserDeleteEmailsResult(@javax.annotation.Nonnull UserSelectorArg user, @javax.annotation.Nonnull List<DeleteSecondaryEmailResult> results) {
        if (user == null) {
        ...
        for (DeleteSecondaryEmailResult x : results) {
            if (x == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            UserDeleteEmailsResult other = (UserDeleteEmailsResult) obj;
     ...
     */
    static class Serializer extends StructSerializer<UserDeleteEmailsResult> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(UserDeleteEmailsResult value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
            ...
            StoneSerializers.list(DeleteSecondaryEmailResult.Serializer.INSTANCE).serialize(value.results, g);
            if (!collapse) {
                g.writeEndObject();
            }
        }
        ...
        @Override
        public UserDeleteEmailsResult deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            UserDeleteEmailsResult value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                List<DeleteSecondaryEmailResult> f_results = null;
                while (p.getCurrentToken() == JsonToken.FIELD_NAME) {
                    ...
                    if ("user".equals(field)) {
                        ...
                        f_results = StoneSerializers.list(DeleteSecondaryEmailResult.Serializer.INSTANCE).deserialize(p);
                    }
                    else {
                        skipValue(p);
                    }
                ...
                value = new UserDeleteEmailsResult(f_user, f_results);
            }
            else {
