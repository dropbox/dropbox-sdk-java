...
class TeamFolderListArg {
    // struct team.TeamFolderListArg (team_team_folders.stone)
     ...
     *     preconditions.
     */
    public TeamFolderListArg(long limit) {
        if (limit < 1L) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamFolderListArg other = (TeamFolderListArg) obj;
    ...
    static class Serializer extends StructSerializer<TeamFolderListArg> {
        ...
        @Override
        public void serialize(TeamFolderListArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamFolderListArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamFolderListArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamFolderListArg(f_limit);
            }
            else {
