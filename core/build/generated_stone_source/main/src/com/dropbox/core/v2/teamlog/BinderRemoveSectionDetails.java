...
public class BinderRemoveSectionDetails {
    // struct team_log.BinderRemoveSectionDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public BinderRemoveSectionDetails(@Nonnull String eventUuid, @Nonnull String docTitle, @Nonnull String binderItemName) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            BinderRemoveSectionDetails other = (BinderRemoveSectionDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<BinderRemoveSectionDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(BinderRemoveSectionDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public BinderRemoveSectionDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            BinderRemoveSectionDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new BinderRemoveSectionDetails(f_eventUuid, f_docTitle, f_binderItemName);
            }
            else {
