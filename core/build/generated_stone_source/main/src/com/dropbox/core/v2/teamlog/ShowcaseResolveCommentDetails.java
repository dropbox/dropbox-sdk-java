...
public class ShowcaseResolveCommentDetails {
    // struct team_log.ShowcaseResolveCommentDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ShowcaseResolveCommentDetails(@javax.annotation.Nonnull String eventUuid, @javax.annotation.Nullable String commentText) {
        if (eventUuid == null) {
     ...
     *     preconditions.
     */
    public ShowcaseResolveCommentDetails(String eventUuid) {
        this(eventUuid, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcaseResolveCommentDetails other = (ShowcaseResolveCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<ShowcaseResolveCommentDetails> {
        ...
        @Override
        public void serialize(ShowcaseResolveCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcaseResolveCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShowcaseResolveCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShowcaseResolveCommentDetails(f_eventUuid, f_commentText);
            }
            else {
