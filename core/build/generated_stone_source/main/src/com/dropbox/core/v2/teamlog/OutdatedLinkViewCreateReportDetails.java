...
public class OutdatedLinkViewCreateReportDetails {
    // struct team_log.OutdatedLinkViewCreateReportDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            OutdatedLinkViewCreateReportDetails other = (OutdatedLinkViewCreateReportDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<OutdatedLinkViewCreateReportDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(OutdatedLinkViewCreateReportDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public OutdatedLinkViewCreateReportDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            OutdatedLinkViewCreateReportDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new OutdatedLinkViewCreateReportDetails(f_startDate, f_endDate);
            }
            else {
