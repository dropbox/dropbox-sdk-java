...
public class PaperDocViewDetails {
    // struct team_log.PaperDocViewDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocViewDetails other = (PaperDocViewDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocViewDetails> {
        ...
        @Override
        public void serialize(PaperDocViewDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocViewDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocViewDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocViewDetails(f_eventUuid);
            }
            else {
