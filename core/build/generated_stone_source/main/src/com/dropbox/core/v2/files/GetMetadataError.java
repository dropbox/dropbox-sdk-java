...
public final class GetMetadataError {
    // union files.GetMetadataError (files_files_public_types.stone)
     ...
     */
    private GetMetadataError withTag(Tag _tag) {
        GetMetadataError result = new GetMetadataError();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private GetMetadataError withTagAndPath(Tag _tag, LookupError pathValue) {
        GetMetadataError result = new GetMetadataError();
        result._tag = _tag;
    ...
    public static GetMetadataError path(LookupError value) {
        ...
        return new GetMetadataError().withTagAndPath(Tag.PATH, value);
    }
