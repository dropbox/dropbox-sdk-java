...
public class ShowcaseRemoveMemberDetails {
    // struct team_log.ShowcaseRemoveMemberDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ShowcaseRemoveMemberDetails(@Nonnull String eventUuid) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcaseRemoveMemberDetails other = (ShowcaseRemoveMemberDetails) obj;
    ...
    static class Serializer extends StructSerializer<ShowcaseRemoveMemberDetails> {
        ...
        @Override
        public void serialize(ShowcaseRemoveMemberDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcaseRemoveMemberDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new ShowcaseRemoveMemberDetails(f_eventUuid);
            }
            else {
