...
public class ShowcaseRenamedDetails {
    // struct team_log.ShowcaseRenamedDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public ShowcaseRenamedDetails(@Nonnull String eventUuid) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcaseRenamedDetails other = (ShowcaseRenamedDetails) obj;
    ...
    static class Serializer extends StructSerializer<ShowcaseRenamedDetails> {
        ...
        @Override
        public void serialize(ShowcaseRenamedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcaseRenamedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShowcaseRenamedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShowcaseRenamedDetails(f_eventUuid);
            }
            else {
