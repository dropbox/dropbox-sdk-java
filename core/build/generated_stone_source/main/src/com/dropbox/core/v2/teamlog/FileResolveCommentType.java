...
public class FileResolveCommentType {
    // struct team_log.FileResolveCommentType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileResolveCommentType other = (FileResolveCommentType) obj;
    ...
    static class Serializer extends StructSerializer<FileResolveCommentType> {
        ...
        @Override
        public void serialize(FileResolveCommentType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileResolveCommentType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileResolveCommentType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileResolveCommentType(f_description);
            }
            else {
