...
public class ShowcaseDeleteCommentDetails {
     ...
     *     preconditions.
     */
    public ShowcaseDeleteCommentDetails(@javax.annotation.Nonnull String eventUuid, @javax.annotation.Nullable String commentText) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcaseDeleteCommentDetails other = (ShowcaseDeleteCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<ShowcaseDeleteCommentDetails> {
        ...
        @Override
        public void serialize(ShowcaseDeleteCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcaseDeleteCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShowcaseDeleteCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShowcaseDeleteCommentDetails(f_eventUuid, f_commentText);
            }
            else {
