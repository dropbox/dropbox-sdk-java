...
public class OrganizationName {
    // struct team_log.OrganizationName (team_log_stone_gen_team_log_generated.stone)
     ...
     */
    static class Serializer extends StructSerializer<OrganizationName> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(OrganizationName value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public OrganizationName deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new OrganizationName(f_organization);
            }
            else {
