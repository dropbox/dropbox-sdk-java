...
public class CreateFolderType {
    // struct team_log.CreateFolderType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public CreateFolderType(@Nonnull String description) {
        if (description == null) {
    ...
    static class Serializer extends StructSerializer<CreateFolderType> {
        ...
        @Override
        public void serialize(CreateFolderType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public CreateFolderType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new CreateFolderType(f_description);
            }
            else {
