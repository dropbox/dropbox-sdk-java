...
class AddSecondaryEmailsArg {
    // struct team.AddSecondaryEmailsArg (team_apiv2_team_members_secondary_emails.stone)
     ...
     *     preconditions.
     */
    public AddSecondaryEmailsArg(@Nonnull List<UserSecondaryEmailsArg> newSecondaryEmails) {
