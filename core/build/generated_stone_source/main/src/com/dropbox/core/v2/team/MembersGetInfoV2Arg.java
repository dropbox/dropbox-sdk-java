...
class MembersGetInfoV2Arg {
    // struct team.MembersGetInfoV2Arg (team_team_members_types.stone)
     ...
     *     preconditions.
     */
    public MembersGetInfoV2Arg(@Nonnull List<UserSelectorArg> members) {
        if (members == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            MembersGetInfoV2Arg other = (MembersGetInfoV2Arg) obj;
     ...
     */
    static class Serializer extends StructSerializer<MembersGetInfoV2Arg> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(MembersGetInfoV2Arg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public MembersGetInfoV2Arg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            MembersGetInfoV2Arg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new MembersGetInfoV2Arg(f_members);
            }
            else {
