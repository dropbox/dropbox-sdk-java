...
public class LegalHoldsExportCancelledDetails {
    // struct team_log.LegalHoldsExportCancelledDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public LegalHoldsExportCancelledDetails(@Nonnull String legalHoldId, @Nonnull String name, @Nonnull String exportName) {
        if (legalHoldId == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            LegalHoldsExportCancelledDetails other = (LegalHoldsExportCancelledDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<LegalHoldsExportCancelledDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(LegalHoldsExportCancelledDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public LegalHoldsExportCancelledDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            LegalHoldsExportCancelledDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new LegalHoldsExportCancelledDetails(f_legalHoldId, f_name, f_exportName);
            }
            else {
