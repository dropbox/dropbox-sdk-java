...
public class WebSessionsChangeActiveSessionLimitDetails {
    // struct team_log.WebSessionsChangeActiveSessionLimitDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     * @param newValue  New max number of concurrent active sessions policy.
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            WebSessionsChangeActiveSessionLimitDetails other = (WebSessionsChangeActiveSessionLimitDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<WebSessionsChangeActiveSessionLimitDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(WebSessionsChangeActiveSessionLimitDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public WebSessionsChangeActiveSessionLimitDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            WebSessionsChangeActiveSessionLimitDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new WebSessionsChangeActiveSessionLimitDetails(f_previousValue, f_newValue);
            }
            else {
