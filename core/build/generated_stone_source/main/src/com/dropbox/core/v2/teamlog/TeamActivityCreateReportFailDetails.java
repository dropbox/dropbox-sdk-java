...
public class TeamActivityCreateReportFailDetails {
     ...
     *     preconditions.
     */
    public TeamActivityCreateReportFailDetails(@javax.annotation.Nonnull TeamReportFailureReason failureReason) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamActivityCreateReportFailDetails other = (TeamActivityCreateReportFailDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamActivityCreateReportFailDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamActivityCreateReportFailDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamActivityCreateReportFailDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamActivityCreateReportFailDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamActivityCreateReportFailDetails(f_failureReason);
            }
            else {
