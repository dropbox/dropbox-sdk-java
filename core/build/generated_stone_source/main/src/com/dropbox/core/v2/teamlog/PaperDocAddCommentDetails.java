...
public class PaperDocAddCommentDetails {
    // struct team_log.PaperDocAddCommentDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocAddCommentDetails(@Nonnull String eventUuid, @Nullable String commentText) {
        if (eventUuid == null) {
     ...
     *     preconditions.
     */
    public PaperDocAddCommentDetails(@Nonnull String eventUuid) {
        this(eventUuid, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocAddCommentDetails other = (PaperDocAddCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocAddCommentDetails> {
        ...
        @Override
        public void serialize(PaperDocAddCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocAddCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocAddCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocAddCommentDetails(f_eventUuid, f_commentText);
            }
            else {
