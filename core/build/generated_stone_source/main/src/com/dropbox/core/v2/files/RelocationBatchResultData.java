...
public class RelocationBatchResultData {
    // struct files.RelocationBatchResultData (files_files_public_types.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            RelocationBatchResultData other = (RelocationBatchResultData) obj;
    ...
    static class Serializer extends StructSerializer<RelocationBatchResultData> {
        ...
        @Override
        public void serialize(RelocationBatchResultData value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public RelocationBatchResultData deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            RelocationBatchResultData value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new RelocationBatchResultData(f_metadata);
            }
            else {
