...
public enum NamespaceType {
    // union team.NamespaceType (team.stone)
    /**
     * App sandbox folder.
     */
    APP_FOLDER,
    ...
    static class Serializer extends UnionSerializer<NamespaceType> {
        ...
        public NamespaceType deserialize(JsonParser p) throws IOException, JsonParseException {
            ...
            else if ("app_folder".equals(tag)) {
                value = NamespaceType.APP_FOLDER;
            }
            else if ("shared_folder".equals(tag)) {
                value = NamespaceType.SHARED_FOLDER;
            }
            else if ("team_folder".equals(tag)) {
                value = NamespaceType.TEAM_FOLDER;
            }
