...
public class ObjectLabelAddedType {
    // struct team_log.ObjectLabelAddedType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ObjectLabelAddedType other = (ObjectLabelAddedType) obj;
     ...
     */
    static class Serializer extends StructSerializer<ObjectLabelAddedType> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(ObjectLabelAddedType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ObjectLabelAddedType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ObjectLabelAddedType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ObjectLabelAddedType(f_description);
            }
            else {
