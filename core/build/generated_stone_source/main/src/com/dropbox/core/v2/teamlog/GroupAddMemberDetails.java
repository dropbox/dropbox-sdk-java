...
public class GroupAddMemberDetails {
    // struct team_log.GroupAddMemberDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     */
    public GroupAddMemberDetails(boolean isGroupOwner) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GroupAddMemberDetails other = (GroupAddMemberDetails) obj;
    ...
    static class Serializer extends StructSerializer<GroupAddMemberDetails> {
        ...
        @Override
        public void serialize(GroupAddMemberDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GroupAddMemberDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GroupAddMemberDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GroupAddMemberDetails(f_isGroupOwner);
            }
            else {
