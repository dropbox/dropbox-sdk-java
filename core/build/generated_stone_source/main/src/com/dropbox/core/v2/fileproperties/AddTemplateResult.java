...
public class AddTemplateResult {
    // struct file_properties.AddTemplateResult (file_properties_apiv2_file_properties_types.stone)
     ...
     *     preconditions.
     */
    public AddTemplateResult(@Nonnull String templateId) {
        if (templateId == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            AddTemplateResult other = (AddTemplateResult) obj;
    ...
    public static class Serializer extends StructSerializer<AddTemplateResult> {
        ...
        @Override
        public void serialize(AddTemplateResult value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public AddTemplateResult deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new AddTemplateResult(f_templateId);
            }
            else {
