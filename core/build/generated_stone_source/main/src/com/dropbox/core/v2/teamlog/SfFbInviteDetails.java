...
public class SfFbInviteDetails {
    // struct team_log.SfFbInviteDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SfFbInviteDetails(long targetAssetIndex, @Nonnull String originalFolderName, @Nullable String sharingPermission) {
