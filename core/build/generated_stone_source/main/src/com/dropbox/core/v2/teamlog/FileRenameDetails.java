...
public class FileRenameDetails {
    // struct team_log.FileRenameDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileRenameDetails other = (FileRenameDetails) obj;
    ...
    static class Serializer extends StructSerializer<FileRenameDetails> {
        ...
        @Override
        public void serialize(FileRenameDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileRenameDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileRenameDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileRenameDetails(f_relocateActionDetails);
            }
            else {
