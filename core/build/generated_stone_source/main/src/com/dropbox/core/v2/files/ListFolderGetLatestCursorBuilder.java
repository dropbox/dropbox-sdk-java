...
public class ListFolderGetLatestCursorBuilder {
     ...
     * @return this builder
     */
    public ListFolderGetLatestCursorBuilder withIncludeMountedFolders(Boolean includeMountedFolders) {
     ...
     *     preconditions.
     */
    public ListFolderGetLatestCursorBuilder withLimit(Long limit) {
     ...
     * @return this builder
     */
    public ListFolderGetLatestCursorBuilder withIncludeNonDownloadableFiles(Boolean includeNonDownloadableFiles) {
     ...
     * @return this builder
     */
    public ListFolderGetLatestCursorBuilder withIncludeRestorableInfo(Boolean includeRestorableInfo) {
