...
public class MemberChangeExternalIdDetails {
    // struct team_log.MemberChangeExternalIdDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            MemberChangeExternalIdDetails other = (MemberChangeExternalIdDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<MemberChangeExternalIdDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(MemberChangeExternalIdDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public MemberChangeExternalIdDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            MemberChangeExternalIdDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new MemberChangeExternalIdDetails(f_newValue, f_previousValue);
            }
            else {
