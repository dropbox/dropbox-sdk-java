...
public class PaperDocTrashedDetails {
    // struct team_log.PaperDocTrashedDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocTrashedDetails(@Nonnull String eventUuid) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocTrashedDetails other = (PaperDocTrashedDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocTrashedDetails> {
        ...
        @Override
        public void serialize(PaperDocTrashedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocTrashedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocTrashedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocTrashedDetails(f_eventUuid);
            }
            else {
