...
public class FolderOverviewItemUnpinnedDetails {
    // struct team_log.FolderOverviewItemUnpinnedDetails (team_log.stone)
     ...
     *     preconditions.
     */
    public FolderOverviewItemUnpinnedDetails(long folderOverviewLocationAsset, @Nonnull List<Long> pinnedItemsAssetIndices) {
