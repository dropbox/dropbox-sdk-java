...
public class FileLikeCommentType {
    // struct team_log.FileLikeCommentType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public FileLikeCommentType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileLikeCommentType other = (FileLikeCommentType) obj;
    ...
    static class Serializer extends StructSerializer<FileLikeCommentType> {
        ...
        @Override
        public void serialize(FileLikeCommentType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileLikeCommentType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileLikeCommentType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileLikeCommentType(f_description);
            }
            else {
