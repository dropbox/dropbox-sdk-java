...
public class SfFbInviteChangeRoleType {
    // struct team_log.SfFbInviteChangeRoleType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SfFbInviteChangeRoleType other = (SfFbInviteChangeRoleType) obj;
    ...
    static class Serializer extends StructSerializer<SfFbInviteChangeRoleType> {
        ...
        @Override
        public void serialize(SfFbInviteChangeRoleType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SfFbInviteChangeRoleType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new SfFbInviteChangeRoleType(f_description);
            }
            else {
