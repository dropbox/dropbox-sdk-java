...
public class ShowcaseFileViewType {
    // struct team_log.ShowcaseFileViewType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShowcaseFileViewType other = (ShowcaseFileViewType) obj;
    ...
    static class Serializer extends StructSerializer<ShowcaseFileViewType> {
        ...
        @Override
        public void serialize(ShowcaseFileViewType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShowcaseFileViewType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShowcaseFileViewType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShowcaseFileViewType(f_description);
            }
            else {
