...
public class RewindFolderType {
    // struct team_log.RewindFolderType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            RewindFolderType other = (RewindFolderType) obj;
     ...
     */
    static class Serializer extends StructSerializer<RewindFolderType> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(RewindFolderType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public RewindFolderType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            RewindFolderType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new RewindFolderType(f_description);
            }
            else {
