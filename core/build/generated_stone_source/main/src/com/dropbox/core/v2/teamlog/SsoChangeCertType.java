...
public class SsoChangeCertType {
    // struct team_log.SsoChangeCertType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SsoChangeCertType other = (SsoChangeCertType) obj;
    ...
    static class Serializer extends StructSerializer<SsoChangeCertType> {
        ...
        @Override
        public void serialize(SsoChangeCertType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SsoChangeCertType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SsoChangeCertType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SsoChangeCertType(f_description);
            }
            else {
