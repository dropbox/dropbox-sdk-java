...
public class SsoChangeLogoutUrlType {
    // struct team_log.SsoChangeLogoutUrlType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SsoChangeLogoutUrlType other = (SsoChangeLogoutUrlType) obj;
    ...
    static class Serializer extends StructSerializer<SsoChangeLogoutUrlType> {
        ...
        @Override
        public void serialize(SsoChangeLogoutUrlType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SsoChangeLogoutUrlType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SsoChangeLogoutUrlType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SsoChangeLogoutUrlType(f_description);
            }
            else {
