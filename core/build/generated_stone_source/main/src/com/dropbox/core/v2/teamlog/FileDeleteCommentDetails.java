...
public class FileDeleteCommentDetails {
    // struct team_log.FileDeleteCommentDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileDeleteCommentDetails other = (FileDeleteCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<FileDeleteCommentDetails> {
        ...
        @Override
        public void serialize(FileDeleteCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileDeleteCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileDeleteCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileDeleteCommentDetails(f_commentText);
            }
            else {
