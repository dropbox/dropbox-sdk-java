...
public class GroupRemoveMemberType {
    // struct team_log.GroupRemoveMemberType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public GroupRemoveMemberType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GroupRemoveMemberType other = (GroupRemoveMemberType) obj;
    ...
    static class Serializer extends StructSerializer<GroupRemoveMemberType> {
        ...
        @Override
        public void serialize(GroupRemoveMemberType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GroupRemoveMemberType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GroupRemoveMemberType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GroupRemoveMemberType(f_description);
            }
            else {
