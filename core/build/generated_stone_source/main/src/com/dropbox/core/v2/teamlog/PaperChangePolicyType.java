...
public class PaperChangePolicyType {
    // struct team_log.PaperChangePolicyType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperChangePolicyType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperChangePolicyType other = (PaperChangePolicyType) obj;
    ...
    static class Serializer extends StructSerializer<PaperChangePolicyType> {
        ...
        @Override
        public void serialize(PaperChangePolicyType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperChangePolicyType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperChangePolicyType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperChangePolicyType(f_description);
            }
            else {
