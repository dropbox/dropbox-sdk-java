...
public class SharedContentChangeViewerInfoPolicyType {
    // struct team_log.SharedContentChangeViewerInfoPolicyType (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public SharedContentChangeViewerInfoPolicyType(@Nonnull String description) {
        if (description == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharedContentChangeViewerInfoPolicyType other = (SharedContentChangeViewerInfoPolicyType) obj;
    ...
    static class Serializer extends StructSerializer<SharedContentChangeViewerInfoPolicyType> {
        ...
        @Override
        public void serialize(SharedContentChangeViewerInfoPolicyType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharedContentChangeViewerInfoPolicyType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new SharedContentChangeViewerInfoPolicyType(f_description);
            }
            else {
