...
public class MembersListResult {
    // struct team.MembersListResult (team_team_members_types.stone)
     ...
     *     preconditions.
     */
    public MembersListResult(@Nonnull List<TeamMemberInfo> members, @Nonnull String cursor, boolean hasMore) {
        if (members == null) {
