...
public class Metadata {
    // struct files.Metadata (files_files_public_base.stone)
    ...
    public static class Builder {
        ...
        public Metadata build() {
            return new Metadata(name, pathLower, pathDisplay, parentSharedFolderId, previewUrl);
        }
    }
    ...
    static class Serializer extends StructSerializer<Metadata> {
        ...
        public Metadata deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new Metadata(f_name, f_pathLower, f_pathDisplay, f_parentSharedFolderId, f_previewUrl);
            }
            else if ("".equals(tag)) {
