...
public class GovernancePolicyReportCreatedDetails {
    // struct team_log.GovernancePolicyReportCreatedDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public GovernancePolicyReportCreatedDetails(@Nonnull String governancePolicyId, @Nonnull String name, @Nullable PolicyType policyType) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GovernancePolicyReportCreatedDetails other = (GovernancePolicyReportCreatedDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<GovernancePolicyReportCreatedDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(GovernancePolicyReportCreatedDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GovernancePolicyReportCreatedDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GovernancePolicyReportCreatedDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GovernancePolicyReportCreatedDetails(f_governancePolicyId, f_name, f_policyType);
            }
            else {
