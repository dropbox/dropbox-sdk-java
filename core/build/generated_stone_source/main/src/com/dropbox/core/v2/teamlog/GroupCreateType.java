...
public class GroupCreateType {
    // struct team_log.GroupCreateType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GroupCreateType other = (GroupCreateType) obj;
    ...
    static class Serializer extends StructSerializer<GroupCreateType> {
        ...
        @Override
        public void serialize(GroupCreateType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GroupCreateType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GroupCreateType value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GroupCreateType(f_description);
            }
            else {
