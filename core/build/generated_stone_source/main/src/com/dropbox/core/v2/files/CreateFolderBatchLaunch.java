 ...
 * DbxUserFilesRequests#createFolderBatch(java.util.List)} that may either
...
public final class CreateFolderBatchLaunch {
    // union files.CreateFolderBatchLaunch (files_files_public_types.stone)

    /**
     * Discriminating tag type for {@link CreateFolderBatchLaunch}.
     */
    public enum Tag {
        /**
     ...
     */
    private CreateFolderBatchLaunch withTag(Tag _tag) {
        CreateFolderBatchLaunch result = new CreateFolderBatchLaunch();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private CreateFolderBatchLaunch withTagAndAsyncJobId(Tag _tag, String asyncJobIdValue) {
        CreateFolderBatchLaunch result = new CreateFolderBatchLaunch();
        result._tag = _tag;
     ...
     *     preconditions.
     */
    private CreateFolderBatchLaunch withTagAndComplete(Tag _tag, CreateFolderBatchResult completeValue) {
        CreateFolderBatchLaunch result = new CreateFolderBatchLaunch();
        result._tag = _tag;
     ...
     * values for this {@code CreateFolderBatchLaunch}. </p>
     *
    ...
    /**
     * Returns an instance of {@code CreateFolderBatchLaunch} that has its tag
     ...
     *
     * @return Instance of {@code CreateFolderBatchLaunch} with its tag set to
     *     {@link Tag#ASYNC_JOB_ID}.
     *
     * @throws IllegalArgumentException  if {@code value} is shorter than 1 or
     *     is {@code null}.
     */
    public static CreateFolderBatchLaunch asyncJobId(String value) {
        if (value == null) {
        ...
        return new CreateFolderBatchLaunch().withTagAndAsyncJobId(Tag.ASYNC_JOB_ID, value);
    }
     ...
     */
    public static CreateFolderBatchLaunch complete(CreateFolderBatchResult value) {
        if (value == null) {
            throw new IllegalArgumentException("Value is null");
        }
        return new CreateFolderBatchLaunch().withTagAndComplete(Tag.COMPLETE, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        else if (obj instanceof CreateFolderBatchLaunch) {
            CreateFolderBatchLaunch other = (CreateFolderBatchLaunch) obj;
    ...
    static class Serializer extends UnionSerializer<CreateFolderBatchLaunch> {
        ...
        @Override
        public void serialize(CreateFolderBatchLaunch value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (value.tag()) {
                case ASYNC_JOB_ID: {
                    g.writeStartObject();
        ...
        @Override
        public CreateFolderBatchLaunch deserialize(JsonParser p) throws IOException, JsonParseException {
            CreateFolderBatchLaunch value;
            boolean collapsed;
            String tag;
            ...
            if (tag == null) {
                ...
                value = CreateFolderBatchLaunch.asyncJobId(fieldValue);
            }
            else if ("complete".equals(tag)) {
                CreateFolderBatchResult fieldValue = null;
                fieldValue = CreateFolderBatchResult.Serializer.INSTANCE.deserialize(p, true);
                value = CreateFolderBatchLaunch.complete(fieldValue);
            }
            else {
                value = CreateFolderBatchLaunch.OTHER;
            }
            if (!collapsed) {
                skipFields(p);
                expectEndObject(p);
