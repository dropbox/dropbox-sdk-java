...
public class EmmErrorDetails {
    // struct team_log.EmmErrorDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            EmmErrorDetails other = (EmmErrorDetails) obj;
    ...
    static class Serializer extends StructSerializer<EmmErrorDetails> {
        ...
        @Override
        public void serialize(EmmErrorDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public EmmErrorDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            EmmErrorDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new EmmErrorDetails(f_errorDetails);
            }
            else {
