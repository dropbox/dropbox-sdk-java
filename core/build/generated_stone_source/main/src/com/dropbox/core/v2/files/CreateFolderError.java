...
public final class CreateFolderError {
    // union files.CreateFolderError (files_files_public_types.stone)
     ...
     */
    private CreateFolderError withTag(Tag _tag) {
        CreateFolderError result = new CreateFolderError();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private CreateFolderError withTagAndPath(Tag _tag, WriteError pathValue) {
        CreateFolderError result = new CreateFolderError();
        result._tag = _tag;
    ...
    public static CreateFolderError path(WriteError value) {
        ...
        return new CreateFolderError().withTagAndPath(Tag.PATH, value);
    }
