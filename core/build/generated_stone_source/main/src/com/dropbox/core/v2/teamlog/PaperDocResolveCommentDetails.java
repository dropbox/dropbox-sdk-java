...
public class PaperDocResolveCommentDetails {
    // struct team_log.PaperDocResolveCommentDetails (team_log_stone_gen_team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocResolveCommentDetails(@Nonnull String eventUuid, @Nullable String commentText) {
        if (eventUuid == null) {
