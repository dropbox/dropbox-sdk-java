...
public class PaperDocResolveCommentDetails {
    // struct team_log.PaperDocResolveCommentDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public PaperDocResolveCommentDetails(@javax.annotation.Nonnull String eventUuid, @javax.annotation.Nullable String commentText) {
        if (eventUuid == null) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperDocResolveCommentDetails other = (PaperDocResolveCommentDetails) obj;
    ...
    static class Serializer extends StructSerializer<PaperDocResolveCommentDetails> {
        ...
        @Override
        public void serialize(PaperDocResolveCommentDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperDocResolveCommentDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            PaperDocResolveCommentDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new PaperDocResolveCommentDetails(f_eventUuid, f_commentText);
            }
            else {
