...
public class FileTransfersTransferDeleteDetails {
    // struct team_log.FileTransfersTransferDeleteDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileTransfersTransferDeleteDetails other = (FileTransfersTransferDeleteDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<FileTransfersTransferDeleteDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(FileTransfersTransferDeleteDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileTransfersTransferDeleteDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileTransfersTransferDeleteDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileTransfersTransferDeleteDetails(f_fileTransferId);
            }
            else {
