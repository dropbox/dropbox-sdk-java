...
public class BinderAddSectionDetails {
    // struct team_log.BinderAddSectionDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            BinderAddSectionDetails other = (BinderAddSectionDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<BinderAddSectionDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(BinderAddSectionDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public BinderAddSectionDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            BinderAddSectionDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new BinderAddSectionDetails(f_eventUuid, f_docTitle, f_binderItemName);
            }
            else {
