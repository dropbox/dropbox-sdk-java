...
public class ShmodelDisableDownloadsDetails {
    // struct team_log.ShmodelDisableDownloadsDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ShmodelDisableDownloadsDetails other = (ShmodelDisableDownloadsDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<ShmodelDisableDownloadsDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(ShmodelDisableDownloadsDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ShmodelDisableDownloadsDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ShmodelDisableDownloadsDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ShmodelDisableDownloadsDetails(f_sharedLinkOwner);
            }
            else {
