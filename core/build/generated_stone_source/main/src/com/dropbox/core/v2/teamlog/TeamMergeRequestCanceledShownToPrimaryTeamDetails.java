...
public class TeamMergeRequestCanceledShownToPrimaryTeamDetails {
    // struct team_log.TeamMergeRequestCanceledShownToPrimaryTeamDetails (team_log_generated.stone)
     ...
     *     preconditions.
     */
    public TeamMergeRequestCanceledShownToPrimaryTeamDetails(@javax.annotation.Nonnull String secondaryTeam, @javax.annotation.Nonnull String sentBy) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            TeamMergeRequestCanceledShownToPrimaryTeamDetails other = (TeamMergeRequestCanceledShownToPrimaryTeamDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<TeamMergeRequestCanceledShownToPrimaryTeamDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(TeamMergeRequestCanceledShownToPrimaryTeamDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public TeamMergeRequestCanceledShownToPrimaryTeamDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            TeamMergeRequestCanceledShownToPrimaryTeamDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new TeamMergeRequestCanceledShownToPrimaryTeamDetails(f_secondaryTeam, f_sentBy);
            }
            else {
