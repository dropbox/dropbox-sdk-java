...
class SharingAllowlistAddArgs {
    // struct team.SharingAllowlistAddArgs (team_apiv2_team_sharing_allowlist.stone)
    ...
    /**
     * Builder for {@link SharingAllowlistAddArgs}.
     */
    public static class Builder {
        ...
        /**
         * Builds an instance of {@link SharingAllowlistAddArgs} configured with
         * this builder's values
         *
         * @return new instance of {@link SharingAllowlistAddArgs}
         */
        public SharingAllowlistAddArgs build() {
            return new SharingAllowlistAddArgs(domains, emails);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SharingAllowlistAddArgs other = (SharingAllowlistAddArgs) obj;
     ...
     */
    static class Serializer extends StructSerializer<SharingAllowlistAddArgs> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(SharingAllowlistAddArgs value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharingAllowlistAddArgs deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            SharingAllowlistAddArgs value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new SharingAllowlistAddArgs(f_domains, f_emails);
            }
            else {
