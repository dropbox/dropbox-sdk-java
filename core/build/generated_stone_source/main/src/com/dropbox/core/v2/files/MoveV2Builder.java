...
/**
 * The request builder returned by {@link DbxUserFilesRequests#moveV2Builder}.
 *
...
public class MoveV2Builder {
     ...
     */
    MoveV2Builder(DbxUserFilesRequests _client, RelocationArg.Builder _builder) {
        if (_client == null) {
     ...
     * @return this builder
     */
    public MoveV2Builder withAllowSharedFolder(Boolean allowSharedFolder) {
