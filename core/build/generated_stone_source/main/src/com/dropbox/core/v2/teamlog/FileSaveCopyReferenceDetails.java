...
public class FileSaveCopyReferenceDetails {
    // struct team_log.FileSaveCopyReferenceDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileSaveCopyReferenceDetails other = (FileSaveCopyReferenceDetails) obj;
    ...
    static class Serializer extends StructSerializer<FileSaveCopyReferenceDetails> {
        ...
        @Override
        public void serialize(FileSaveCopyReferenceDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileSaveCopyReferenceDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileSaveCopyReferenceDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileSaveCopyReferenceDetails(f_relocateActionDetails);
            }
            else {
