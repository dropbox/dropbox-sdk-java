...
public class PaperFolderDeletedType {
    // struct team_log.PaperFolderDeletedType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            PaperFolderDeletedType other = (PaperFolderDeletedType) obj;
    ...
    static class Serializer extends StructSerializer<PaperFolderDeletedType> {
        ...
        @Override
        public void serialize(PaperFolderDeletedType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PaperFolderDeletedType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new PaperFolderDeletedType(f_description);
            }
            else {
