...
public class BinderRenameSectionDetails {
    // struct team_log.BinderRenameSectionDetails (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            BinderRenameSectionDetails other = (BinderRenameSectionDetails) obj;
     ...
     */
    static class Serializer extends StructSerializer<BinderRenameSectionDetails> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(BinderRenameSectionDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public BinderRenameSectionDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            BinderRenameSectionDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new BinderRenameSectionDetails(f_eventUuid, f_docTitle, f_binderItemName, f_previousBinderItemName);
            }
            else {
