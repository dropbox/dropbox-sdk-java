...
public class FileRequestCloseDetails {
    // struct team_log.FileRequestCloseDetails (team_log_generated.stone)
    ...
    /**
     * Builder for {@link FileRequestCloseDetails}.
     */
    public static class Builder {
        ...
        /**
         * Builds an instance of {@link FileRequestCloseDetails} configured with
         * this builder's values
         *
         * @return new instance of {@link FileRequestCloseDetails}
         */
        public FileRequestCloseDetails build() {
            return new FileRequestCloseDetails(fileRequestId, previousDetails);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileRequestCloseDetails other = (FileRequestCloseDetails) obj;
    ...
    static class Serializer extends StructSerializer<FileRequestCloseDetails> {
        ...
        @Override
        public void serialize(FileRequestCloseDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileRequestCloseDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new FileRequestCloseDetails(f_fileRequestId, f_previousDetails);
            }
            else {
