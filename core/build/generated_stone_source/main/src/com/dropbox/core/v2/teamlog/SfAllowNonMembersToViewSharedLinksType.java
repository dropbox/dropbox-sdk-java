...
public class SfAllowNonMembersToViewSharedLinksType {
    // struct team_log.SfAllowNonMembersToViewSharedLinksType (team_log_stone_gen_team_log_generated.stone)
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            SfAllowNonMembersToViewSharedLinksType other = (SfAllowNonMembersToViewSharedLinksType) obj;
    ...
    static class Serializer extends StructSerializer<SfAllowNonMembersToViewSharedLinksType> {
        ...
        @Override
        public void serialize(SfAllowNonMembersToViewSharedLinksType value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SfAllowNonMembersToViewSharedLinksType deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new SfAllowNonMembersToViewSharedLinksType(f_description);
            }
            else {
