...
import com.dropbox.core.android.OwpDbxOfficialAppConnector;
 ...
 * intent action {@value OwpDbxOfficialAppConnector#ACTION_DBXC_EDIT} and
 * {@value OwpDbxOfficialAppConnector#ACTION_DBXC_VIEW} to jump to their apps. Don't follow this if
...
public class OpenWithActivity extends DropboxActivity {
    private OwpDbxOfficialAppConnector mDoac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateIntentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent decodedIntent = OwpDbxOfficialAppConnector
        ...
        mInstalled.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OwpDbxOfficialAppConnector.DbxOfficialAppInstallInfo installInfo =
                        OwpDbxOfficialAppConnector.isInstalled(OpenWithActivity.this);
        ...
        mGenLinked.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean isSigned = OwpDbxOfficialAppConnector.isAnySignedIn(OpenWithActivity.this);
    ...
    private void handleFakeOpenWithIntent(Intent intent) {
        if (intent.getAction() == OwpDbxOfficialAppConnector.ACTION_DBXC_EDIT ||
                intent.getAction() == OwpDbxOfficialAppConnector.ACTION_DBXC_VIEW) {
            String path = intent.getStringExtra(OwpDbxOfficialAppConnector.EXTRA_DROPBOX_PATH);
            String uid = intent.getStringExtra(OwpDbxOfficialAppConnector.EXTRA_DROPBOX_UID);
            boolean read_only = intent.getBooleanExtra(OwpDbxOfficialAppConnector.EXTRA_DROPBOX_READ_ONLY, false);
            String session_id = intent.getStringExtra(OwpDbxOfficialAppConnector.EXTRA_DROPBOX_SESSION_ID);
    ...
    protected Intent generateOpenWithIntent(String path) {
        ...
        Intent owpIntent = new Intent(OwpDbxOfficialAppConnector.ACTION_DBXC_EDIT, uri);

        // extras
        owpIntent.putExtra(OwpDbxOfficialAppConnector.EXTRA_DROPBOX_PATH, path);
        owpIntent.putExtra(OwpDbxOfficialAppConnector.EXTRA_DROPBOX_UID, uid);
        owpIntent.putExtra(OwpDbxOfficialAppConnector.EXTRA_DROPBOX_READ_ONLY, false);
        owpIntent.putExtra(OwpDbxOfficialAppConnector.EXTRA_DROPBOX_SESSION_ID, "generated");
    ...
    protected void loadData() {
        try {
            ...
            this.mDoac = new OwpDbxOfficialAppConnector(uid);
