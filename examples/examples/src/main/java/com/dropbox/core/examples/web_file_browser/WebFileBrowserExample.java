 ...
 */
public class WebFileBrowserExample extends AbstractHandler {
    private final Common common;
    private final DropboxAuth dropboxAuth;
    private final DropboxBrowse dropboxBrowse;

    private WebFileBrowserExample(PrintWriter log, DbxAppInfo dbxAppInfo, File userDbFile) throws IOException, Common.DatabaseException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Run server
        try {
            WebFileBrowserExample main = new WebFileBrowserExample(new PrintWriter(System.out, true), dbxAppInfo, dbFile);
