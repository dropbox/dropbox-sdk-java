...
Dropbox is working on a project to improve out OAuth flow to support new permission model and 
short lived token. This feature is still at early access phase. All endpoints are gated, only 
...
Here is more [documentation](https://www.dropbox.com/lp/developers/reference/oauth-guide.html) for our new oauth2 flow. Please reach out to us if you are interested in trying this feature!
