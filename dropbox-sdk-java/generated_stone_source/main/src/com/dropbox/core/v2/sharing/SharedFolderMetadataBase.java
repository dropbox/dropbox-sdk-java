...
public class SharedFolderMetadataBase {
    ...
    public static class Builder {
        ...
        public SharedFolderMetadataBase build() {
            return new SharedFolderMetadataBase(accessType, isInsideTeamFolder, isTeamFolder, ownerDisplayNames, ownerTeam, parentSharedFolderId, pathLower, parentFolderName);
        }
    }
    ...
    private static class Serializer extends StructSerializer<SharedFolderMetadataBase> {
        ...
        public SharedFolderMetadataBase deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new SharedFolderMetadataBase(f_accessType, f_isInsideTeamFolder, f_isTeamFolder, f_ownerDisplayNames, f_ownerTeam, f_parentSharedFolderId, f_pathLower, f_parentFolderName);
            }
            else {
