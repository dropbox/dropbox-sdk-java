...
public final class DbxRequestUtil {
    ...
    public static HttpRequestor.Header buildUserAgentHeader(DbxRequestConfig requestConfig, String sdkUserAgentIdentifier) {
        String versionString = requestConfig.getSdkVersion() != null ? requestConfig.getSdkVersion() : "Unknown";
        return new HttpRequestor.Header("User-Agent",  requestConfig.getClientIdentifier() + " " + sdkUserAgentIdentifier + "/" + versionString);
    }
