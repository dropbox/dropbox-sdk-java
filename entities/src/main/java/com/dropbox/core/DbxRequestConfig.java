...
public class DbxRequestConfig {
    @Nonnull private final String sdkVersion;
    ...
    private DbxRequestConfig(
        ...
        this.sdkVersion = sdkVersion != null ? sdkVersion : "unknown";
    ...
    public DbxRequestConfig(String clientIdentifier, /*@Nullable*/ String userLocale, HttpRequestor httpRequestor) {
        this(clientIdentifier, null, userLocale, httpRequestor, 0);
    }
    ...
    /**
     * Returns the sdkVersion you passed in when constructing this object.
     *
     * <p>
     * The skdVersion identifies the version of the official Dropbox SDK that is
     * being used.
     * </p>
     *
     * @return The Official Dropbox SDK version, or null.
     */
    @Nullable
     ...
     */
    public Builder copy() {
        return new Builder(sdkVersion, clientIdentifier, userLocale, httpRequestor, maxRetries);
    }
    ...
    public static final class Builder {
        private final String clientIdentifier;
        @Nullable private String sdkVersion = null;
        ...
        /**
         * Set the Official Dropbox SDK version for use in user agent strings.
         * @param sdkVersion The version of the Dropbox SDK, or null.
         * @return This builder.
         */
        public Builder withSdkVersion(@Nullable String sdkVersion) {
            this.sdkVersion = sdkVersion;
            return this;
        }
        ...
        public DbxRequestConfig build() {
            return new DbxRequestConfig(clientIdentifier, sdkVersion, userLocale, httpRequestor, maxRetries);
        }
    }
}
