...
public final class DbxSharing {
    ...
    public static class CreateSharedLinkArg {
         ...
         * either {@code pendingUploadMode.file} or {@code
     ...
     * and {@link DbxUsers#getAccountBatch(java.util.ArrayList)}` to obtain more
     ...
     * be identified by the absence of {@code sharedFolderMetadata.pathLower}.
     */
    public static class ListFoldersResult {
        ...
        public ListFoldersResult(java.util.ArrayList<SharedFolderMetadata> entries, String cursor) {
    ...
    public enum ListFoldersContinueError {
        ...
        /**
         * {@code listFoldersContinueArg.cursor} is invalid.
         */
        invalidCursor,
        other;  // *catch_all
        ...
        {
            public void write(ListFoldersContinueError x, JsonGenerator g)
             throws IOException
            {
                switch (x) {
                    case invalidCursor:
        ...
        private static final java.util.HashMap<String,ListFoldersContinueError> _values;
        static {
            _values = new java.util.HashMap<String,ListFoldersContinueError>();
    ...
    public static class SharedFolderMembers {
         ...
         */
        public final java.util.ArrayList<UserMembershipInfo> users;
        /**
        ...
        public SharedFolderMembers(java.util.ArrayList<UserMembershipInfo> users, java.util.ArrayList<GroupMembershipInfo> groups, java.util.ArrayList<InviteeMembershipInfo> invitees, String cursor) {
            this.users = users;
            if (users == null) {
        ...
        public static final JsonReader<SharedFolderMembers> _reader = new JsonReader<SharedFolderMembers>() {
            ...
            public final SharedFolderMembers readFields(JsonParser parser)
                throws IOException, JsonReadException
            {
                java.util.ArrayList<UserMembershipInfo> users = null;
    ...
    public static final class ListFolderMembersContinueError {
        ...
        private ListFolderMembersContinueError(Tag t, SharedFolderAccessError v) {
            tag = t;
            accessErrorValue = v;
            validate();
        }
        public static ListFolderMembersContinueError accessError(SharedFolderAccessError v) {
            return new ListFolderMembersContinueError(Tag.accessError, v);
        }
        ...
        /**
         * {@code listFolderMembersContinueArg.cursor} is invalid.
         */
        ...
        public static final JsonReader<ListFolderMembersContinueError> _reader = new JsonReader<ListFolderMembersContinueError>()
        {
              ...
              throws IOException, JsonReadException
            {
                if (parser.getCurrentToken() == JsonToken.VALUE_STRING) {
                    ...
                    switch (tag) {
                        case invalidCursor: return ListFolderMembersContinueError.invalidCursor;
    ...
    public static final class ShareFolderJobStatus {
        ...
        private ShareFolderJobStatus(Tag t, SharedFolderMetadata v) {
            tag = t;
            completeValue = v;
            failedValue = null;
            validate();
         ...
         */
        public static ShareFolderJobStatus complete(SharedFolderMetadata v) {
    ...
    public static final class ShareFolderLaunch {
        ...
        private final SharedFolderMetadata completeValue;
        private ShareFolderLaunch(Tag t, SharedFolderMetadata v) {
            tag = t;
            asyncJobIdValue = null;
            completeValue = v;
            validate();
        }
        public static ShareFolderLaunch complete(SharedFolderMetadata v) {
    ...
    public static final class TransferFolderError {
        ...
        /**
         * {@code transferFolderArg.toDropboxId} is invalid.
         */
              ...
              throws IOException, JsonReadException
            {
                if (parser.getCurrentToken() == JsonToken.VALUE_STRING) {
                    ...
                    switch (tag) {
                        ...
                        case newOwnerNotAMember: return TransferFolderError.newOwnerNotAMember;
              ...
              throws IOException, JsonReadException
            {
                if (parser.getCurrentToken() == JsonToken.VALUE_STRING) {
                    ...
                    switch (tag) {
                        ...
                        case rateLimit: return AddFolderMemberError.rateLimit;
    ...
    public static final class UpdateFolderMemberError {
        ...
        private final SharedFolderMemberError memberErrorValue;
        private UpdateFolderMemberError(Tag t, SharedFolderMemberError v) {
            tag = t;
            accessErrorValue = null;
            memberErrorValue = v;
            validate();
        }
        public static UpdateFolderMemberError memberError(SharedFolderMemberError v) {
            return new UpdateFolderMemberError(Tag.memberError, v);
        }
        public SharedFolderMemberError getMemberError() {
            if (tag != Tag.memberError) {
                throw new RuntimeException("getMemberError() requires tag==memberError, actual tag=="+tag);
     ...
     * PathLinkMetadata}, the {@code pathLinkMetadata.url} field is the
     * shortened URL if {@code createSharedLinkArg.shortUrl} argument is set to
     * {@literal true}. Previously, it was technically possible to break a
    ...
    public static class ListFoldersContinueException extends DbxApiException {
        ...
        public ListFoldersContinueException(ListFoldersContinueError errorValue) {
            super("Exception in list_folders/continue: " + errorValue);
            this.errorValue = errorValue;
        }
    }
    /**
     * Once a cursor has been retrieved from {@link DbxSharing#listFolders}, use
     * this to paginate through all shared folders. Warning: This endpoint is in
            ...
            throws ListFoldersContinueException, DbxException
    {
        try {
            return DbxRawClientV2.rpcStyle(client.getRequestConfig(),
                                           client.getAccessToken(),
                                           client.getHost().api,
                                           "2-beta-2/sharing/list_folders/continue",
                                           arg,
            ...
            throw new ListFoldersContinueException((ListFoldersContinueError) (ew.errValue));
        }
    }
    /**
     * Once a cursor has been retrieved from {@link DbxSharing#listFolders}, use
    ...
    public static class ListFolderMembersException extends DbxApiException {
        ...
        public ListFolderMembersException(SharedFolderAccessError errorValue) {
            super("Exception in list_folder_members: " + errorValue);
            this.errorValue = errorValue;
        }
    }
    /**
     * Returns shared folder membership by its folder ID. Warning: This endpoint
     * is in beta and is subject to minor but possibly backwards-incompatible
     * changes.
     */
            ...
            throws ListFolderMembersException, DbxException
    {
        try {
            return DbxRawClientV2.rpcStyle(client.getRequestConfig(),
                                           client.getAccessToken(),
                                           client.getHost().api,
                                           "2-beta-2/sharing/list_folder_members",
                                           arg,
            ...
            throw new ListFolderMembersException((SharedFolderAccessError) (ew.errValue));
        }
    }
    /**
     * Returns shared folder membership by its folder ID. Warning: This endpoint
    ...
    public static class ListFolderMembersContinueException extends DbxApiException {
        ...
        public ListFolderMembersContinueException(ListFolderMembersContinueError errorValue) {
            super("Exception in list_folder_members/continue: " + errorValue);
            this.errorValue = errorValue;
        }
    }
    /**
     ...
     * shared folder members. Warning: This endpoint is in beta and is subject
            ...
            throws ListFolderMembersContinueException, DbxException
    {
        try {
            return DbxRawClientV2.rpcStyle(client.getRequestConfig(),
                                           client.getAccessToken(),
                                           client.getHost().api,
                                           "2-beta-2/sharing/list_folder_members/continue",
                                           arg,
            ...
            throw new ListFolderMembersContinueException((ListFolderMembersContinueError) (ew.errValue));
        }
    }
    /**
     * Once a cursor has been retrieved from {@link
     ...
     * to get the metadata for the folder. Warning: This endpoint is in beta and
     ...
     * completed successfully. Warning: This endpoint is in beta and is subject
     * to minor but possibly backwards-incompatible changes.
     */
     ...
     * DbxSharing#mountFolder(String)} on their behalf. Warning: This endpoint
     * is in beta and is subject to minor but possibly backwards-incompatible
     * changes.
     */
     ...
     * folder at a later time using {@link DbxSharing#mountFolder(String)}.
     * Warning: This endpoint is in beta and is subject to minor but possibly
     * backwards-incompatible changes.
     */
