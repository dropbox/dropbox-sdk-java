...
public final class ListRevisionsError {
     ...
     * this {@code ListRevisionsError}. </p>
     *
     ...
     * {@link Tag#PATH}.
     *
     * @param value  {@link ListRevisionsError#path} value to assign to this
     *     instance.
     *
    ...
    public static ListRevisionsError fromJson(String s) throws JsonReadException {
        return _JSON_READER.readFully(s);
    }

    public static final JsonWriter<ListRevisionsError> _JSON_WRITER = new JsonWriter<ListRevisionsError>() {
        public final void write(ListRevisionsError x, JsonGenerator g) throws IOException {
            switch (x.tag) {
                case PATH:
                    g.writeStartObject();
    ...
    public static final JsonReader<ListRevisionsError> _JSON_READER = new JsonReader<ListRevisionsError>() {

        public final ListRevisionsError read(JsonParser parser) throws IOException, JsonReadException {
