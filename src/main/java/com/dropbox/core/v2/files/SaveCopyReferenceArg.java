...
@JsonSerialize(using=SaveCopyReferenceArg.Serializer.class)
@JsonDeserialize(using=SaveCopyReferenceArg.Deserializer.class)
class SaveCopyReferenceArg {
    ...
    static final class Serializer extends StructJsonSerializer<SaveCopyReferenceArg> {
        private static final long serialVersionUID = 0L;

        public Serializer() {
            super(SaveCopyReferenceArg.class);
        }

        public Serializer(boolean unwrapping) {
            super(SaveCopyReferenceArg.class, unwrapping);
        }

        @Override
        protected JsonSerializer<SaveCopyReferenceArg> asUnwrapping() {
            return new Serializer(true);
        }

        @Override
        protected void serializeFields(SaveCopyReferenceArg value, JsonGenerator g, SerializerProvider provider) throws IOException, JsonProcessingException {
            g.writeObjectField("copy_reference", value.copyReference);
            g.writeObjectField("path", value.path);
        }
    }

    static final class Deserializer extends StructJsonDeserializer<SaveCopyReferenceArg> {
        private static final long serialVersionUID = 0L;
        ...
        @Override
        protected JsonDeserializer<SaveCopyReferenceArg> asUnwrapping() {
            return new Deserializer(true);
        }

        @Override
        public SaveCopyReferenceArg deserializeFields(JsonParser _p, DeserializationContext _ctx) throws IOException, JsonParseException {
            ...
            while (_p.getCurrentToken() == JsonToken.FIELD_NAME) {
                ...
                _p.nextToken();
                if ("copy_reference".equals(_field)) {
            ...
            return new SaveCopyReferenceArg(copyReference, path);
        }
    }
}
