 ...
 * will be used. </p>
 */
@JsonSerialize(using=GetTemporaryLinkError.Serializer.class)
@JsonDeserialize(using=GetTemporaryLinkError.Deserializer.class)
public final class GetTemporaryLinkError {
    ...
    static final class Serializer extends UnionJsonSerializer<GetTemporaryLinkError> {
        private static final long serialVersionUID = 0L;

        public Serializer() {
            super(GetTemporaryLinkError.class);
        }

        @Override
        public void serialize(GetTemporaryLinkError value, JsonGenerator g, SerializerProvider provider) throws IOException, JsonProcessingException {
            switch (value.tag) {
                case PATH:
                    g.writeStartObject();
    ...
    static final class Deserializer extends UnionJsonDeserializer<GetTemporaryLinkError, Tag> {
        private static final long serialVersionUID = 0L;

        public Deserializer() {
            super(GetTemporaryLinkError.class, getTagMapping(), Tag.OTHER);
        }

        @Override
        public GetTemporaryLinkError deserialize(Tag _tag, JsonParser _p, DeserializationContext _ctx) throws IOException, JsonParseException {
            switch (_tag) {
                case PATH: {
                    ...
                    _p.nextToken();
                    return GetTemporaryLinkError.path(value);
                }
                case OTHER: {
        ...
        private static Map<String, GetTemporaryLinkError.Tag> getTagMapping() {
            Map<String, GetTemporaryLinkError.Tag> values = new HashMap<String, GetTemporaryLinkError.Tag>();
            values.put("path", GetTemporaryLinkError.Tag.PATH);
            values.put("other", GetTemporaryLinkError.Tag.OTHER);
