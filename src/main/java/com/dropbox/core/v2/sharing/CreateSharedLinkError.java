...
public final class CreateSharedLinkError {
     ...
     * this {@code CreateSharedLinkError}. </p>
     *
     ...
     * to {@link Tag#PATH}.
     *
     * @param value  {@link CreateSharedLinkError#path} value to assign to this
     *     instance.
     *
    ...
    public static CreateSharedLinkError fromJson(String s) throws JsonReadException {
        return _JSON_READER.readFully(s);
    }

    public static final JsonWriter<CreateSharedLinkError> _JSON_WRITER = new JsonWriter<CreateSharedLinkError>() {
        public final void write(CreateSharedLinkError x, JsonGenerator g) throws IOException {
            switch (x.tag) {
                case PATH:
                    g.writeStartObject();
    ...
    public static final JsonReader<CreateSharedLinkError> _JSON_READER = new JsonReader<CreateSharedLinkError>() {

        public final CreateSharedLinkError read(JsonParser parser) throws IOException, JsonReadException {
