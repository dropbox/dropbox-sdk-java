...
public final class ListFileMembersContinueError {
    ...
    public enum Tag {
         ...
         * DbxUserSharingRequests#listFileMembersContinue(String)} is invalid.
         */
        INVALID_CURSOR,
        /**
     ...
     */
    private ListFileMembersContinueError(Tag tag, SharingUserError userErrorValue, SharingFileAccessError accessErrorValue) {
        this.tag = tag;
     ...
     *
     * @return The {@link ListFileMembersContinueError#userError} value
     *     associated with this instance if {@link #isUserError} is {@code
     *     true}.
     *
     ...
     *
     * @return The {@link ListFileMembersContinueError#accessError} value
     ...
     */
    static final class Serializer extends UnionSerializer<ListFileMembersContinueError> {
