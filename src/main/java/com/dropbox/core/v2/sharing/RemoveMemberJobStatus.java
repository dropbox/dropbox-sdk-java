...
public final class RemoveMemberJobStatus {
     ...
     */
    private RemoveMemberJobStatus(Tag tag, MemberAccessLevelResult completeValue, RemoveFolderMemberError failedValue) {
        this.tag = tag;
     ...
     *
     * @return The {@link RemoveMemberJobStatus#complete} value associated with
     ...
     *
     * @return The {@link RemoveMemberJobStatus#failed} value associated with
     ...
     */
    static final class Serializer extends UnionSerializer<RemoveMemberJobStatus> {
