...
public final class AddFileMemberError {
     ...
     */
    private AddFileMemberError(Tag tag, SharingUserError userErrorValue, SharingFileAccessError accessErrorValue) {
        this.tag = tag;
     ...
     *
     * @return The {@link AddFileMemberError#userError} value associated with
     ...
     *
     * @return The {@link AddFileMemberError#accessError} value associated with
    ...
    public boolean isInvalidComment() {
        return this.tag == Tag.INVALID_COMMENT;
    }
     ...
     */
    static final class Serializer extends UnionSerializer<AddFileMemberError> {
