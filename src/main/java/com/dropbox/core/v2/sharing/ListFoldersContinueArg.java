...
class ListFoldersContinueArg {
    ...
    static final class Serializer extends StructJsonSerializer<ListFoldersContinueArg> {
        private static final long serialVersionUID = 0L;

        public Serializer() {
            super(ListFoldersContinueArg.class);
        }

        public Serializer(boolean unwrapping) {
            super(ListFoldersContinueArg.class, unwrapping);
        }

        @Override
        protected JsonSerializer<ListFoldersContinueArg> asUnwrapping() {
            return new Serializer(true);
        }

        @Override
        protected void serializeFields(ListFoldersContinueArg value, JsonGenerator g, SerializerProvider provider) throws IOException, JsonProcessingException {
            g.writeObjectField("cursor", value.cursor);
        }
    }

    static final class Deserializer extends StructJsonDeserializer<ListFoldersContinueArg> {
        private static final long serialVersionUID = 0L;
        ...
        @Override
        protected JsonDeserializer<ListFoldersContinueArg> asUnwrapping() {
            return new Deserializer(true);
        }

        @Override
        public ListFoldersContinueArg deserializeFields(JsonParser _p, DeserializationContext _ctx) throws IOException, JsonParseException {
