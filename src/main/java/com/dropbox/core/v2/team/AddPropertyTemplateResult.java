...
public class AddPropertyTemplateResult {
     ...
     */
    static final class Serializer extends StructSerializer<AddPropertyTemplateResult> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(AddPropertyTemplateResult value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public AddPropertyTemplateResult deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            AddPropertyTemplateResult value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new AddPropertyTemplateResult(f_templateId);
            }
            else {
