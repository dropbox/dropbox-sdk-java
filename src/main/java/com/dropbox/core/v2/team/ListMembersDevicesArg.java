...
@JsonSerialize(using=ListMembersDevicesArg.Serializer.class)
@JsonDeserialize(using=ListMembersDevicesArg.Deserializer.class)
class ListMembersDevicesArg {
    ...
    static final class Serializer extends StructJsonSerializer<ListMembersDevicesArg> {
        private static final long serialVersionUID = 0L;

        public Serializer() {
            super(ListMembersDevicesArg.class);
        }

        public Serializer(boolean unwrapping) {
            super(ListMembersDevicesArg.class, unwrapping);
        }

        @Override
        protected JsonSerializer<ListMembersDevicesArg> asUnwrapping() {
            return new Serializer(true);
        }

        @Override
        protected void serializeFields(ListMembersDevicesArg value, JsonGenerator g, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    static final class Deserializer extends StructJsonDeserializer<ListMembersDevicesArg> {
        private static final long serialVersionUID = 0L;
        ...
        @Override
        protected JsonDeserializer<ListMembersDevicesArg> asUnwrapping() {
            return new Deserializer(true);
        }

        @Override
        public ListMembersDevicesArg deserializeFields(JsonParser _p, DeserializationContext _ctx) throws IOException, JsonParseException {
