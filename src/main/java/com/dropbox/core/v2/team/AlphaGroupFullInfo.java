...
import com.dropbox.core.v2.teamcommon.AlphaGroupSummary;
 ...
 */
public class AlphaGroupFullInfo extends AlphaGroupSummary {
    // struct AlphaGroupFullInfo
     ...
     *     preconditions.
     */
    public AlphaGroupFullInfo(String groupName, String groupId, GroupManagementType groupManagementType, long created, String groupExternalId, Long memberCount, List<GroupMemberInfo> members) {
     ...
     *     preconditions.
     */
    public AlphaGroupFullInfo(String groupName, String groupId, GroupManagementType groupManagementType, long created) {
    ...
    /**
     * Builder for {@link AlphaGroupFullInfo}.
     */
    public static class Builder extends AlphaGroupSummary.Builder {
        protected final long created;
        ...
        /**
         * Builds an instance of {@link AlphaGroupFullInfo} configured with this
         * builder's values
         *
         * @return new instance of {@link AlphaGroupFullInfo}
         */
        public AlphaGroupFullInfo build() {
            return new AlphaGroupFullInfo(groupName, groupId, groupManagementType, created, groupExternalId, memberCount, members);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            AlphaGroupFullInfo other = (AlphaGroupFullInfo) obj;
     ...
     */
    static final class Serializer extends StructSerializer<AlphaGroupFullInfo> {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void serialize(AlphaGroupFullInfo value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public AlphaGroupFullInfo deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new AlphaGroupFullInfo(f_groupName, f_groupId, f_groupManagementType, f_created, f_groupExternalId, f_memberCount, f_members);
            }
            else {
