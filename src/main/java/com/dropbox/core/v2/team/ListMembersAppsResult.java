...
public class ListMembersAppsResult {
     ...
     *     cursor to {@link
     *     DbxTeamTeamRequests#linkedAppsListMembersLinkedApps()} to retrieve
     *     the rest.
     * @param cursor  Pass the cursor into {@link
     *     DbxTeamTeamRequests#linkedAppsListMembersLinkedApps()} to receive the
     ...
     * DbxTeamTeamRequests#linkedAppsListMembersLinkedApps()} to retrieve the
     * rest.
     *
