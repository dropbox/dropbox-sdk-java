/* DO NOT EDIT */
/* This file was generated from team.babel, team_common.babel, team_devices.babel, team_groups.babel, team_linked_apps.babel, team_members.babel, team_reports.babel */
...
public final class DbxTeam {
    ...
    public DbxTeam(DbxRawClientV2 client) {
        this.client = client;
    }
    ...
    public TeamGetInfoResult getInfo() throws DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   null,
                                   TeamGetInfoResult._JSON_READER,
     ...
     ListMemberDevicesResult devicesListMemberDevices(ListMemberDevicesArg listMemberDevicesArg) throws ListMemberDevicesErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   ListMemberDevicesArg._JSON_WRITER,
                                   ListMemberDevicesResult._JSON_READER,
                                   ListMemberDevicesError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     * See {@link ListMemberDevicesArg} for more details. </p>
     *
     ...
     ListTeamDevicesResult devicesListTeamDevices(ListTeamDevicesArg listTeamDevicesArg) throws ListTeamDevicesErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   listTeamDevicesArg,
                                   false,
                                   ListTeamDevicesArg._JSON_WRITER,
                                   ListTeamDevicesResult._JSON_READER,
                                   ListTeamDevicesError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link ListTeamDevicesArg} for more details. </p>
     */
    ...
    public void devicesRevokeDeviceSession(RevokeDeviceSessionArg revokeDeviceSessionArg) throws RevokeDeviceSessionErrorException, DbxException {
        try {
            client.rpcStyle(client.getHost().getApi(),
                            ...
                            false,
                            RevokeDeviceSessionArg._JSON_WRITER,
                            JsonReader.VoidReader,
                            RevokeDeviceSessionError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     RevokeDeviceSessionBatchResult devicesRevokeDeviceSessionBatch(RevokeDeviceSessionBatchArg revokeDeviceSessionBatchArg) throws RevokeDeviceSessionBatchErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   RevokeDeviceSessionBatchArg._JSON_WRITER,
                                   RevokeDeviceSessionBatchResult._JSON_READER,
                                   RevokeDeviceSessionBatchError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link RevokeDeviceSessionBatchArg} for more details. </p>
     *
     ...
     GroupsListResult groupsList(GroupsListArg groupsListArg) throws DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   groupsListArg,
                                   false,
                                   GroupsListArg._JSON_WRITER,
                                   GroupsListResult._JSON_READER,
                                   JsonReader.VoidReader);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link GroupsListArg} for more details. </p>
     */
    ...
    /**
     * Once a cursor has been retrieved from {@link DbxTeam#groupsList()}, use
     ...
     GroupsListResult groupsListContinue(GroupsListContinueArg groupsListContinueArg) throws GroupsListContinueErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   GroupsListContinueArg._JSON_WRITER,
                                   GroupsListResult._JSON_READER,
                                   GroupsListContinueError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link GroupsListContinueArg} for more details. </p>
     *
    ...
    public List<GroupsGetInfoItem> groupsGetInfo(GroupsSelector groupsSelector) throws GroupsGetInfoErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   groupsSelector,
                                   false,
                                   GroupsSelector._JSON_WRITER,
                                   JsonArrayReader.mk(GroupsGetInfoItem._JSON_READER),
                                   GroupsGetInfoError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     GroupFullInfo groupsCreate(GroupCreateArg groupCreateArg) throws GroupCreateErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   groupCreateArg,
                                   false,
                                   GroupCreateArg._JSON_WRITER,
                                   GroupFullInfo._JSON_READER,
                                   GroupCreateError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link GroupCreateArg} for more details. </p>
     *
    ...
    public LaunchEmptyResult groupsDelete(GroupSelector groupSelector) throws GroupDeleteErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   groupSelector,
                                   false,
                                   GroupSelector._JSON_WRITER,
                                   LaunchEmptyResult._JSON_READER,
                                   GroupDeleteError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     GroupFullInfo groupsUpdate(GroupUpdateArgs groupUpdateArgs) throws GroupUpdateErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   groupUpdateArgs,
                                   false,
                                   GroupUpdateArgs._JSON_WRITER,
                                   GroupFullInfo._JSON_READER,
                                   GroupUpdateError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link GroupUpdateArgs} for more details. </p>
     *
     ...
     *     DbxTeam#groupsMembersAdd(GroupSelector,List)} and {@link
     *     DbxTeam#groupsMembersRemove(GroupSelector,List)}.
     */
     GroupMembersChangeResult groupsMembersAdd(GroupMembersAddArg groupMembersAddArg) throws GroupMembersAddErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   groupMembersAddArg,
                                   false,
                                   GroupMembersAddArg._JSON_WRITER,
                                   GroupMembersChangeResult._JSON_READER,
                                   GroupMembersAddError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link GroupMembersAddArg} for more details. </p>
     *
     ...
     GroupMembersChangeResult groupsMembersRemove(GroupMembersRemoveArg groupMembersRemoveArg) throws GroupMembersRemoveErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   GroupMembersRemoveArg._JSON_WRITER,
                                   GroupMembersChangeResult._JSON_READER,
                                   GroupMembersRemoveError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link GroupMembersRemoveArg} for more details. </p>
     *
     ...
     List<GroupsGetInfoItem> groupsMembersSetAccessType(GroupMembersSetAccessTypeArg groupMembersSetAccessTypeArg) throws GroupMemberSelectorErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   GroupMembersSetAccessTypeArg._JSON_WRITER,
                                   JsonArrayReader.mk(GroupsGetInfoItem._JSON_READER),
                                   GroupMemberSelectorError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link GroupMembersSetAccessTypeArg} for more details. </p>
     *
     * @param group  Specify a group. Must not be {@code null}.
     ...
     * DbxTeam#groupsDelete(GroupSelector)}, {@link
     * DbxTeam#groupsMembersAdd(GroupSelector,List)} , or {@link
     * DbxTeam#groupsMembersRemove(GroupSelector,List)} use this method to poll
     * the status of granting/revoking group members' access to group-owned
     ...
     PollEmptyResult groupsJobStatusGet(PollArg pollArg) throws GroupsPollErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   PollEmptyResult._JSON_READER,
                                   GroupsPollError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     ListMemberAppsResult linkedAppsListMemberLinkedApps(ListMemberAppsArg listMemberAppsArg) throws ListMemberAppsErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   listMemberAppsArg,
                                   false,
                                   ListMemberAppsArg._JSON_WRITER,
                                   ListMemberAppsResult._JSON_READER,
                                   ListMemberAppsError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link ListMemberAppsArg} for more details. </p>
     *
     ...
     *     DbxTeam#linkedAppsListTeamLinkedApps()}.
     *
     ...
     ListTeamAppsResult linkedAppsListTeamLinkedApps(ListTeamAppsArg listTeamAppsArg) throws ListTeamAppsErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   listTeamAppsArg,
                                   false,
                                   ListTeamAppsArg._JSON_WRITER,
                                   ListTeamAppsResult._JSON_READER,
                                   ListTeamAppsError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link ListTeamAppsArg} for more details. </p>
     *
     * @return Information returned by {@link
     *     DbxTeam#linkedAppsListTeamLinkedApps()}.
     */
     ...
     void linkedAppsRevokeLinkedApp(RevokeLinkedApiAppArg revokeLinkedApiAppArg) throws RevokeLinkedAppErrorException, DbxException {
        try {
            client.rpcStyle(client.getHost().getApi(),
                            ...
                            false,
                            RevokeLinkedApiAppArg._JSON_WRITER,
                            JsonReader.VoidReader,
                            RevokeLinkedAppError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link RevokeLinkedApiAppArg} for more details. </p>
     *
     ...
     RevokeLinkedAppBatchResult linkedAppsRevokeLinkedAppBatch(RevokeLinkedApiAppBatchArg revokeLinkedApiAppBatchArg) throws RevokeLinkedAppBatchErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   RevokeLinkedApiAppBatchArg._JSON_WRITER,
                                   RevokeLinkedAppBatchResult._JSON_READER,
                                   RevokeLinkedAppBatchError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link RevokeLinkedApiAppBatchArg} for more details. </p>
     *
     ...
     MembersListResult membersList(MembersListArg membersListArg) throws MembersListErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   membersListArg,
                                   false,
                                   MembersListArg._JSON_WRITER,
                                   MembersListResult._JSON_READER,
                                   MembersListError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link MembersListArg} for more details. </p>
     */
    ...
    /**
     * Once a cursor has been retrieved from {@link DbxTeam#membersList()}, use
     ...
     MembersListResult membersListContinue(MembersListContinueArg membersListContinueArg) throws MembersListContinueErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   MembersListContinueArg._JSON_WRITER,
                                   MembersListResult._JSON_READER,
                                   MembersListContinueError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link MembersListContinueArg} for more details. </p>
     *
     ...
     List<MembersGetInfoItem> membersGetInfo(MembersGetInfoArgs membersGetInfoArgs) throws MembersGetInfoErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   membersGetInfoArgs,
                                   false,
                                   MembersGetInfoArgs._JSON_WRITER,
                                   JsonArrayReader.mk(MembersGetInfoItem._JSON_READER),
                                   MembersGetInfoError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link MembersGetInfoArgs} for more details. </p>
     *
     ...
     MembersAddLaunch membersAdd(MembersAddArg membersAddArg) throws DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   membersAddArg,
                                   false,
                                   MembersAddArg._JSON_WRITER,
                                   MembersAddLaunch._JSON_READER,
                                   JsonReader.VoidReader);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link MembersAddArg} for more details. </p>
     *
    ...
    /**
     * Once an async_job_id is returned from {@link DbxTeam#membersAdd(List)} ,
     ...
     MembersAddJobStatus membersAddJobStatusGet(PollArg pollArg) throws PollErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   PollArg._JSON_WRITER,
                                   MembersAddJobStatus._JSON_READER,
     ...
     TeamMemberInfo membersSetProfile(MembersSetProfileArg membersSetProfileArg) throws MembersSetProfileErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   MembersSetProfileArg._JSON_WRITER,
                                   TeamMemberInfo._JSON_READER,
                                   MembersSetProfileError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link MembersSetProfileArg} for more details. </p>
     *
     ...
     MembersSetPermissionsResult membersSetAdminPermissions(MembersSetPermissionsArg membersSetPermissionsArg) throws MembersSetPermissionsErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   MembersSetPermissionsArg._JSON_WRITER,
                                   MembersSetPermissionsResult._JSON_READER,
                                   MembersSetPermissionsError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link MembersSetPermissionsArg} for more details. </p>
     *
    ...
    public void membersSendWelcomeEmail(UserSelectorArg userSelectorArg) throws MembersSendWelcomeErrorException, DbxException {
        try {
            client.rpcStyle(client.getHost().getApi(),
                            ...
                            userSelectorArg,
                            false,
                            UserSelectorArg._JSON_WRITER,
                            JsonReader.VoidReader,
                            MembersSendWelcomeError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     LaunchEmptyResult membersRemove(MembersRemoveArg membersRemoveArg) throws MembersRemoveErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   membersRemoveArg,
                                   false,
                                   MembersRemoveArg._JSON_WRITER,
                                   LaunchEmptyResult._JSON_READER,
                                   MembersRemoveError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
    ...
    /**
     * Once an async_job_id is returned from {@link
     * DbxTeam#membersRemove(UserSelectorArg)} , use this to poll the status of
     ...
     void membersSuspend(MembersDeactivateArg membersDeactivateArg) throws MembersSuspendErrorException, DbxException {
        try {
            client.rpcStyle(client.getHost().getApi(),
                            ...
                            false,
                            MembersDeactivateArg._JSON_WRITER,
                            JsonReader.VoidReader,
                            MembersSuspendError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link MembersDeactivateArg} for more details. </p>
     *
     * @param user  Identity of user to remove/suspend. Must not be {@code
     *     null}.
     *
     ...
     void membersUnsuspend(MembersUnsuspendArg membersUnsuspendArg) throws MembersUnsuspendErrorException, DbxException {
        try {
            client.rpcStyle(client.getHost().getApi(),
                            ...
                            membersUnsuspendArg,
                            false,
                            MembersUnsuspendArg._JSON_WRITER,
                            JsonReader.VoidReader,
                            MembersUnsuspendError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link MembersUnsuspendArg} for more details. </p>
     *
     ...
     GetStorageReport reportsGetStorage(DateRange dateRange) throws DateRangeErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   dateRange,
                                   false,
                                   DateRange._JSON_WRITER,
                                   GetStorageReport._JSON_READER,
                                   DateRangeError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
     ...
     *
     * <p> The default values for the remaining request parameters will be used.
     * See {@link DateRange} for more details. </p>
     *
     * @return Storage Report Result. Each of the items in the storage report is
     *     an array of values, one value per day. If there is no data for a day,
     *     then the value will be None.
     ...
     GetActivityReport reportsGetActivity(DateRange dateRange) throws DateRangeErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   DateRange._JSON_WRITER,
                                   GetActivityReport._JSON_READER,
                                   DateRangeError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
            throw new DateRangeErrorException(ew.getRequestId(), ew.getUserMessage(), (DateRangeError) ew.getErrorValue());
     ...
     GetMembershipReport reportsGetMembership(DateRange dateRange) throws DateRangeErrorException, DbxException {
        try {
            return client.rpcStyle(client.getHost().getApi(),
                                   ...
                                   false,
                                   DateRange._JSON_WRITER,
                                   GetMembershipReport._JSON_READER,
                                   DateRangeError._JSON_READER);
        }
        catch (DbxRequestUtil.ErrorWrapper ew) {
            throw new DateRangeErrorException(ew.getRequestId(), ew.getUserMessage(), (DateRangeError) ew.getErrorValue());
