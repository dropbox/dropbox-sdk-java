...
public class Auth {
     ...
     * {@value OwpDbxOfficialAppConnector#ACTION_DBXC_EDIT} and {@value OwpDbxOfficialAppConnector#ACTION_DBXC_VIEW}.
    ...
    public static void startOAuth2Authentication(Context context, String appKey, String desiredUid,
        ...
        // Start Dropbox auth activity.
        AuthActivity.setAuthParams(appKey, desiredUid, alreadyAuthedUids, sessionId);
