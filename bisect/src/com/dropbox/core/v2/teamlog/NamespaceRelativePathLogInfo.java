...
public class NamespaceRelativePathLogInfo {
     ...
     * @param relativePath  A path relative to the specified namespace ID. Might
     *     be missing due to historical data gap.
     * @param isSharedNamespace  True if the namespace is shared. Might be
    ...
    public static class Builder {
         ...
         *
         * @param nsId  Namespace ID. Might be missing due to historical data
         *     gap.
         *
         * @return this builder
         */
