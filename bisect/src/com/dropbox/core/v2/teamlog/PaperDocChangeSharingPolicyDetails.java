...
public class PaperDocChangeSharingPolicyDetails {
     ...
     * @param teamSharingPolicy  Sharing policy with team. Might be missing due
    ...
    public static class Builder {
         ...
         *
         * @param publicSharingPolicy  Sharing policy with external users. Might
         ...
         * Set value for optional field.
         *
         * @param teamSharingPolicy  Sharing policy with team. Might be missing
