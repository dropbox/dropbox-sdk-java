...
public class GroupCreateDetails {
    // struct team_log.GroupCreateDetails (team_log_generated.stone)
     ...
     *
     * @param isCompanyManaged  Is company managed group. Might be missing due
    ...
    /**
     * Builder for {@link GroupCreateDetails}.
     */
    public static class Builder {
         ...
         *
         * @param isCompanyManaged  Is company managed group. Might be missing
        ...
        /**
         * Builds an instance of {@link GroupCreateDetails} configured with this
         * builder's values
         *
         * @return new instance of {@link GroupCreateDetails}
         */
        public GroupCreateDetails build() {
            return new GroupCreateDetails(isCompanyManaged, joinPolicy);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            GroupCreateDetails other = (GroupCreateDetails) obj;
    ...
    static class Serializer extends StructSerializer<GroupCreateDetails> {
        ...
        @Override
        public void serialize(GroupCreateDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GroupCreateDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            GroupCreateDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new GroupCreateDetails(f_isCompanyManaged, f_joinPolicy);
            }
            else {
