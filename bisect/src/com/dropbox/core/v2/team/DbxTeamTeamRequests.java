/* DO NOT EDIT */
/* This file was generated from team_devices.stone, team_secondary_mails.stone, team_members.stone, team_linked_apps.stone, team_reports.stone, team_folders.stone, team_member_space_limits.stone, team_legal_holds.stone, team.stone, team_groups.stone, team_namespaces.stone */
...
public class DbxTeamTeamRequests {
    // namespace team (team_devices.stone, team_secondary_mails.stone, team_members.stone, team_linked_apps.stone, team_reports.stone, team_folders.stone, team_member_space_limits.stone, team_legal_holds.stone, team.stone, team_groups.stone, team_namespaces.stone)
     ...
     *     {@code null}.
     * @param members  List of team members added to the hold. Must not contain
     *     a {@code null} item and not be {@code null}.
     *
     * @throws IllegalArgumentException  If any argument does not meet its
     *     preconditions.
    ...
    //
    // route 2/team/legal_holds/export_policy
    //
     ...
     *
     */
    LegalHoldsExportPolicyResult legalHoldsExportPolicy(LegalHoldsPolicyExportArg arg) throws LegalHoldsExportPolicyErrorException, DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
                                        "2/team/legal_holds/export_policy",
                                        arg,
                                        false,
                                        LegalHoldsPolicyExportArg.Serializer.INSTANCE,
                                        LegalHoldsExportPolicyResult.Serializer.INSTANCE,
                                        LegalHoldsExportPolicyError.Serializer.INSTANCE);
        }
        catch (DbxWrappedException ex) {
            throw new LegalHoldsExportPolicyErrorException("2/team/legal_holds/export_policy", ex.getRequestId(), ex.getUserMessage(), (LegalHoldsExportPolicyError) ex.getErrorValue());
        }
    }
     ...
     * @param path  The selected destination path in the team's Dropbox for the
     *     export. The path must be a namespace path (see example) of a
     *     namespace that's accessible to the application. To get the list of
     *     accessible namespaces use the route {@link
     *     DbxTeamTeamRequests#namespacesList(long)}. Must match pattern "{@code
    ...
    //
    // route 2/team/legal_holds/export_policy_job_status/check
    //

    /**
     * Returns the status of an asynchronous job for {@link
     * DbxTeamTeamRequests#legalHoldsExportPolicyJobStatusCheck(String)}.
     * Permission : Team member file access.
     *
     * @param arg  Arguments for methods that poll the status of an asynchronous
     *     job.
     */
    ExportPolicyJobStatusResult legalHoldsExportPolicyJobStatusCheck(PollArg arg) throws PollErrorException, DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
                                        "2/team/legal_holds/export_policy_job_status/check",
                                        arg,
                                        false,
                                        PollArg.Serializer.INSTANCE,
                                        ExportPolicyJobStatusResult.Serializer.INSTANCE,
                                        PollError.Serializer.INSTANCE);
        }
        catch (DbxWrappedException ex) {
            throw new PollErrorException("2/team/legal_holds/export_policy_job_status/check", ex.getRequestId(), ex.getUserMessage(), (PollError) ex.getErrorValue());
        }
    }
     ...
     * @param id  The legal hold Id. Must match pattern "{@code ^pid_dbhid:.+}"
     *     and not be {@code null}.
     * @param cursor  cursor of list held revisions. Must have length of at
     *     least 1.
     *
     * @throws IllegalArgumentException  If any argument does not meet its
     *     preconditions.
     ...
     * @param id  The legal hold Id. Must match pattern "{@code ^pid_dbhid:.+}"
     *     and not be {@code null}.
     * @param members  List of team members to apply the policy on. Must not
     *     contain a {@code null} item and not be {@code null}.
     *
     * @throws IllegalArgumentException  If any argument does not meet its
     *     preconditions.
     */
    public LegalHoldPolicy legalHoldsUpdatePolicy(String id, List<String> members) throws LegalHoldsPolicyUpdateErrorException, DbxException {
        LegalHoldsPolicyUpdateArg _arg = new LegalHoldsPolicyUpdateArg(id, members);
     ...
     *     preconditions.
     */
    public LegalHoldsUpdatePolicyBuilder legalHoldsUpdatePolicyBuilder(String id, List<String> members) {
        LegalHoldsPolicyUpdateArg.Builder argBuilder_ = LegalHoldsPolicyUpdateArg.newBuilder(id, members);
