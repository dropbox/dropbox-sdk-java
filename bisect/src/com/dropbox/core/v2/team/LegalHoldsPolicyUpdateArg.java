...
class LegalHoldsPolicyUpdateArg {
     ...
     *     preconditions.
     */
    public LegalHoldsPolicyUpdateArg(String id, List<String> members, String name, String description) {
        if (id == null) {
     ...
     *     preconditions.
     */
    public LegalHoldsPolicyUpdateArg(String id, List<String> members) {
        this(id, members, null, null);
    }
     ...
     *     preconditions.
     */
    public static Builder newBuilder(String id, List<String> members) {
        return new Builder(id, members);
    }
    ...
    public static class Builder {
        ...
        protected Builder(String id, List<String> members) {
            if (id == null) {
                throw new IllegalArgumentException("Required value for 'id' is null");
            }
            if (!Pattern.matches("^pid_dbhid:.+", id)) {
        ...
        public LegalHoldsPolicyUpdateArg build() {
            return new LegalHoldsPolicyUpdateArg(id, members, name, description);
        }
    }
    ...
    static class Serializer extends StructSerializer<LegalHoldsPolicyUpdateArg> {
        ...
        public LegalHoldsPolicyUpdateArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new LegalHoldsPolicyUpdateArg(f_id, f_members, f_name, f_description);
            }
            else {
