...
public enum FeaturesGetValuesBatchError {
    ...
    static class Serializer extends UnionSerializer<FeaturesGetValuesBatchError> {
        ...
        @Override
        public void serialize(FeaturesGetValuesBatchError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (value) {
        ...
        @Override
        public FeaturesGetValuesBatchError deserialize(JsonParser p) throws IOException, JsonParseException {
            FeaturesGetValuesBatchError value;
            boolean collapsed;
            String tag;
            ...
            if (tag == null) {
                ...
                value = FeaturesGetValuesBatchError.EMPTY_FEATURES_LIST;
            }
            else {
                value = FeaturesGetValuesBatchError.OTHER;
            }
            if (!collapsed) {
                skipFields(p);
                expectEndObject(p);
