...
class MembersRemoveArg extends MembersDeactivateArg {
     ...
     *     to folders already explicitly shared with them (not via a group) when
     *     they are downgraded to a Basic account. Users will not retain access
     *     to folders that do not allow external sharing. In order to keep the
     *     sharing relationships, the arguments the {@code wipeData} argument to
     ...
     * explicitly shared with them (not via a group) when they are downgraded to
     * a Basic account. Users will not retain access to folders that do not
     * allow external sharing. In order to keep the sharing relationships, the
     * arguments the {@code wipeData} argument to {@link
     * DbxTeamTeamRequests#membersSuspend(UserSelectorArg,boolean)} should be
     * set to {@code false} and {@link MembersRemoveArg#getKeepAccount} should
     * be set to {@code true}.
     *
     * @return value for this field, or {@code null} if not present. Defaults to
     *     false.
    ...
    public static class Builder {
         ...
         *     access to folders already explicitly shared with them (not via a
         *     group) when they are downgraded to a Basic account. Users will
         *     not retain access to folders that do not allow external sharing.
         *     In order to keep the sharing relationships, the arguments the
         *     {@code wipeData} argument to {@link
         *     DbxTeamTeamRequests#membersSuspend(UserSelectorArg,boolean)}
         *     should be set to {@code false} and {@link
         *     MembersRemoveArg#getKeepAccount} should be set to {@code true}.
