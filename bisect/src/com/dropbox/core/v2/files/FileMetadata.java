...
public class FileMetadata extends Metadata {
     ...
     *     by {@link DbxUserFilesRequests#listFolderContinue(String)}. This
     ...
     *     DbxUserFilesRequests#listFolderContinue(String)}, or {@link
     ...
     *     preconditions.
     */
    public FileMetadata(String name, String id, Date clientModified, Date serverModified, String rev, long size, String pathLower, String pathDisplay, String parentSharedFolderId, MediaInfo mediaInfo, SymlinkInfo symlinkInfo, FileSharingInfo sharingInfo, boolean isDownloadable, ExportInfo exportInfo, List<PropertyGroup> propertyGroups, Boolean hasExplicitSharedMembers, String contentHash, FileLockMetadata fileLockInfo) {
    ...
    public FileMetadata(String name, String id, Date clientModified, Date serverModified, String rev, long size) {
        this(name, id, clientModified, serverModified, rev, size, null, null, null, null, null, null, true, null, null, null, null, null);
    }
    ...
    public static class Builder extends Metadata.Builder {
        ...
        public FileMetadata build() {
            return new FileMetadata(name, id, clientModified, serverModified, rev, size, pathLower, pathDisplay, parentSharedFolderId, mediaInfo, symlinkInfo, sharingInfo, isDownloadable, exportInfo, propertyGroups, hasExplicitSharedMembers, contentHash, fileLockInfo);
        }
    }
    ...
    static class Serializer extends StructSerializer<FileMetadata> {
        ...
        public FileMetadata deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new FileMetadata(f_name, f_id, f_clientModified, f_serverModified, f_rev, f_size, f_pathLower, f_pathDisplay, f_parentSharedFolderId, f_mediaInfo, f_symlinkInfo, f_sharingInfo, f_isDownloadable, f_exportInfo, f_propertyGroups, f_hasExplicitSharedMembers, f_contentHash, f_fileLockInfo);
            }
            else {
