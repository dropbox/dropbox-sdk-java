...
/**
 * The request builder returned by {@link DbxUserFilesRequests#copyV2Builder}.
 *
...
public class CopyV2Builder {
     ...
     */
    CopyV2Builder(DbxUserFilesRequests _client, RelocationArg.Builder _builder) {
        if (_client == null) {
     ...
     * @return this builder
     */
    public CopyV2Builder withAutorename(Boolean autorename) {
     ...
     * @return this builder
     */
    public CopyV2Builder withAllowOwnershipTransfer(Boolean allowOwnershipTransfer) {
