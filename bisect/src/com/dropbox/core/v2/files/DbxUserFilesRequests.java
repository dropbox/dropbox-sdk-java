...
public class DbxUserFilesRequests {
     ...
     * different from {@link DbxUserFilesRequests#upload(String)}. Do not use
    ...
    AlphaUploadUploader alphaUpload(CommitInfoWithProperties arg) throws DbxException {
        HttpRequestor.Uploader _uploader = this.client.uploadStyle(this.client.getHost().getContent(),
                                                                   ...
                                                                   arg,
                                                                   false,
                                                                   CommitInfoWithProperties.Serializer.INSTANCE);
     ...
     * Create a new file with the contents provided in the request. Note that
     * this endpoint is part of the properties API alpha and is slightly
     * different from {@link DbxUserFilesRequests#upload(String)}.
     *
     * <p> Do not use this to upload a file larger than 150 MB. Instead, create
     * an upload session with {@link
     * DbxUserFilesRequests#uploadSessionStart(boolean)}. </p>
     *
     * <p> The default values for the optional request parameters will be used.
     ...
     *     preconditions.
     *
     * @deprecated use {@link DbxUserFilesRequests#alphaUpload(String)} instead.
     */
    @Deprecated
    public AlphaUploadUploader alphaUpload(String path) throws DbxException {
        CommitInfoWithProperties _arg = new CommitInfoWithProperties(path);
    ...
    public AlphaUploadBuilder alphaUploadBuilder(String path) {
        CommitInfoWithProperties.Builder argBuilder_ = CommitInfoWithProperties.newBuilder(path);
     ...
     * immediately and do the async copy job in background. Please use {@code
     * copyBatchCheck:1} to check the job status.
     *
     *
     ...
     * user's Dropbox.
     *
     * <p> If {@link RelocationBatchArg#getAllowSharedFolder} is false, this
     * route is atomic. If one entry fails, the whole transaction will abort. If
     * {@link RelocationBatchArg#getAllowSharedFolder} is true, atomicity is not
     ...
     *
     * <p> Example succesful temporary upload link consumption response:
     ...
     *
     * <p> curl -X POST
     * https://dl.dropboxusercontent.com/apitul/1/bNi2uIYF51cVBND </p>
     *
     ...
     * content hash of the uploaded data in JSON format. </p>
     *
     * <p> Example succesful temporary upload link consumption response: </p>
     *
     ...
     * extensions: jpg, jpeg, png, tiff, tif, gif and bmp. Photos that are
     * larger than 20MB in size won't be converted to a thumbnail. </p>
     *
     * <p> The default values for the optional request parameters will be used.
     ...
     * user's Dropbox. This route will replace {@code moveBatch:1}. The main
     * difference is this route will return status for each entry, while {@code
     * moveBatch:1} raises failure if any entry fails. This route will either
     ...
     *     Dropbox file. Must not contain a {@code null} item and not be {@code
     *     null}.
     *
     * @throws IllegalArgumentException  If any argument does not meet its
     *     preconditions.
     ...
     *     apply. Must contain at least 1 items, not contain a {@code null}
     ...
     *
     * <p> Note: Recent changes may not immediately be reflected in search
     * results due to a short delay in indexing. </p>
     *
     * <p> The default values for the optional request parameters will be used.
     ...
     *
     * <p> The default values for the optional request parameters will be used.
     * See {@link SearchV2Builder} for more details. </p>
     *
     ...
     * per month. For more information, see the <a
     ...
     * commit job in background. Use {@link
     ...
     * use this route to finish all your upload sessions in a single request.
     *
     * <p> the {@code close} argument to {@link
     * DbxUserFilesRequests#uploadSessionStart(boolean)} or the {@code close}
     * argument to {@link
     * DbxUserFilesRequests#uploadSessionAppendV2(UploadSessionCursor,boolean)}
     * needs to be true for the last {@link
     ...
     * 48 hours. Attempting to use an {@link
     * UploadSessionStartResult#getSessionId} with {@link
     * DbxUserFilesRequests#uploadSessionAppendV2(UploadSessionCursor,boolean)}
     * or {@link
     * DbxUserFilesRequests#uploadSessionFinish(UploadSessionCursor,CommitInfo)}
     * more than 48 hours after its creation will return a {@link
     ...
     * of a file one can upload to an upload session is 350 GB. </p>
     *
     * <p> An upload session can be used for a maximum of 48 hours. Attempting
     * to use an {@link UploadSessionStartResult#getSessionId} with {@link
     * DbxUserFilesRequests#uploadSessionAppendV2(UploadSessionCursor,boolean)}
     * or {@link
     * DbxUserFilesRequests#uploadSessionFinish(UploadSessionCursor,CommitInfo)}
     * more than 48 hours after its creation will return a {@link
