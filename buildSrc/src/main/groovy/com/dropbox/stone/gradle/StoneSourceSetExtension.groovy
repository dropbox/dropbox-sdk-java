 ...
 */
public class StoneSourceSetExtension {
    private final Project project
    private final List<Object> srcDirs
    private final PatternSet patterns

    public StoneSourceSetExtension(Project project, String sourceSetName) {
    ...
    public StoneSourceSetExtension source(SourceDirectorySet source) {
        srcDirs(source.getSrcDirs())
        return this
    }

    public StoneSourceSetExtension srcDir(Object dir) {
        this.srcDirs.add(dir)
        return this
    }

    public StoneSourceSetExtension srcDirs(Object ... dirs) {
