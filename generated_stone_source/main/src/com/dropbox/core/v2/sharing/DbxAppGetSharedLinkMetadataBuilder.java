 ...
 * DbxAppSharingRequests#getSharedLinkMetadataBuilder}.
 *
...
public class DbxAppGetSharedLinkMetadataBuilder {
     ...
     */
    DbxAppGetSharedLinkMetadataBuilder(DbxAppSharingRequests _client, GetSharedLinkMetadataArg.Builder _builder) {
        if (_client == null) {
     ...
     *     preconditions.
     */
    public DbxAppGetSharedLinkMetadataBuilder withPath(String path) {
     ...
     * @return this builder
     */
    public DbxAppGetSharedLinkMetadataBuilder withLinkPassword(String linkPassword) {
