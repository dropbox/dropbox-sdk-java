...
public class FileMoveDetails {
     ...
     *     preconditions.
     */
    public FileMoveDetails(List<RelocateAssetReferencesLogInfo> relocateActionDetails) {
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            FileMoveDetails other = (FileMoveDetails) obj;
    ...
    static class Serializer extends StructSerializer<FileMoveDetails> {
        ...
        @Override
        public void serialize(FileMoveDetails value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileMoveDetails deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            FileMoveDetails value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new FileMoveDetails(f_relocateActionDetails);
            }
            else {
