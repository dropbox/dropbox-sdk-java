...
public class UploadBuilder extends DbxUploadStyleBuilder<FileMetadata, UploadError, UploadErrorException> {
    ...
    private final UploadArg.Builder _builder;
     ...
     */
    UploadBuilder(DbxUserFilesRequests _client, UploadArg.Builder _builder) {
        if (_client == null) {
     ...
     *     the target path refers to a file with identical contents. Defaults to
     ...
     *     preconditions.
     */
    public UploadBuilder withContentHash(String contentHash) {
    ...
    public UploadUploader start() throws UploadErrorException, DbxException {
        UploadArg arg_ = this._builder.build();
