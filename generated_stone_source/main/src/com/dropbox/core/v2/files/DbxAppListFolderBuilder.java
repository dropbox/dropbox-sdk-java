 ...
 * DbxAppFilesRequests#listFolderBuilder}.
 *
...
public class DbxAppListFolderBuilder {
     ...
     */
    DbxAppListFolderBuilder(DbxAppFilesRequests _client, ListFolderArg.Builder _builder) {
        if (_client == null) {
     ...
     * @return this builder
     */
    public DbxAppListFolderBuilder withRecursive(Boolean recursive) {
     ...
     * @return this builder
     */
    public DbxAppListFolderBuilder withIncludeDeleted(Boolean includeDeleted) {
     ...
     * @return this builder
     */
    public DbxAppListFolderBuilder withIncludeHasExplicitSharedMembers(Boolean includeHasExplicitSharedMembers) {
     ...
     * @return this builder
     */
    public DbxAppListFolderBuilder withIncludeMountedFolders(Boolean includeMountedFolders) {
     ...
     *     preconditions.
     */
    public DbxAppListFolderBuilder withLimit(Long limit) {
     ...
     * @return this builder
     */
    public DbxAppListFolderBuilder withIncludeNonDownloadableFiles(Boolean includeNonDownloadableFiles) {
