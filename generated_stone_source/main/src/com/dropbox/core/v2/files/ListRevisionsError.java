...
public final class ListRevisionsError {
     ...
     */
    private ListRevisionsError withTag(Tag _tag) {
        ListRevisionsError result = new ListRevisionsError();
        result._tag = _tag;
        return result;
    }
     ...
     *     preconditions.
     */
    private ListRevisionsError withTagAndPath(Tag _tag, LookupError pathValue) {
        ListRevisionsError result = new ListRevisionsError();
        result._tag = _tag;
    ...
    public static ListRevisionsError path(LookupError value) {
        ...
        return new ListRevisionsError().withTagAndPath(Tag.PATH, value);
    }
