...
public final class WriteMode {
    ...
    public enum Tag {
         ...
         * example, from {@link FileMetadata}, from when the file was last
     ...
     *     file's "rev". The supplied value should be the latest known "rev" of
     *     the file, for example, from {@link FileMetadata}, from when the file
     *     was last downloaded by the app. This will cause the file on the
     ...
     *     strategy is to append the string "conflicted copy" to the file name.
     *     For example, "document.txt" might become "document (conflicted
     *     copy).txt" or "document (Panda's conflicted copy).txt". Must have
     ...
     * supplied value should be the latest known "rev" of the file, for example,
     * from {@link FileMetadata}, from when the file was last downloaded by the
     ...
     * servers. The autorename strategy is to append the string "conflicted
