 ...
 * DbxUserFilesRequests#getThumbnailV2Builder}.
 *
...
public class DbxUserGetThumbnailV2Builder extends DbxDownloadStyleBuilder<PreviewResult> {
     ...
     */
    DbxUserGetThumbnailV2Builder(DbxUserFilesRequests _client, ThumbnailV2Arg.Builder _builder) {
        if (_client == null) {
     ...
     *     preconditions.
     */
    public DbxUserGetThumbnailV2Builder withFormat(ThumbnailFormat format) {
     ...
     *     preconditions.
     */
    public DbxUserGetThumbnailV2Builder withSize(ThumbnailSize size) {
